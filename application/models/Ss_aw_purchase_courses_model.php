  ...
  class Ss_aw_purchase_courses_model extends CI_Model
{
	...
	public function get_single_course_details($student_id){
		$this->db->where('ss_aw_child_id', $student_id);	
		$this->db->where('ss_aw_selected_course_id', 5);	//master course id 5
