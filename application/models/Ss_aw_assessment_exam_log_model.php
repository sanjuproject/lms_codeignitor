...
class Ss_aw_assessment_exam_log_model extends CI_Model
{
    ...
    public function score_subtopic_wise($exam_code, $child_id){
    	$query = "SELECT ael.ss_aw_log_subcategory as sub_category, (SELECT COUNT(*) FROM ss_aw_assessment_exam_log el WHERE ael.ss_aw_log_subcategory = el.ss_aw_log_subcategory AND el.ss_aw_log_answer_status = 1 AND el.ss_aw_log_exam_code = '".$exam_code."' AND el.ss_aw_log_child_id = '".$child_id."') as wright, (SELECT COUNT(*) FROM ss_aw_assessment_exam_log el WHERE ael.ss_aw_log_subcategory = el.ss_aw_log_subcategory AND el.ss_aw_log_answer_status = 2 AND el.ss_aw_log_exam_code = '".$exam_code."' AND el.ss_aw_log_child_id = '".$child_id."') as wrong FROM ss_aw_assessment_exam_log ael WHERE ael.ss_aw_log_exam_code = '".$exam_code."' AND ael.ss_aw_log_child_id = '".$child_id."' GROUP BY ael.ss_aw_log_subcategory";
