...
class Ss_aw_parents_model extends CI_Model
{
	...
	public function login_process($email){
		...
		$this->db->or_where('(select count(*) from ss_aw_childs where ss_aw_childs.ss_aw_parent_id = ss_aw_parents.ss_aw_parent_id and ss_aw_childs.ss_aw_child_username is null) > 0');
		$this->db->group_end();
