...
class Ss_aw_assisment_diagnostic_model extends CI_Model
{
	...
	public function get_bulk_questions($question_ids = array()){
		$this->db->select('ss_aw_id, ss_aw_question_preface as question_preface, ss_aw_question as question, ss_aw_category as topic_name, ss_aw_level as question_level, ss_aw_answers as correct_answer');
		$this->db->from($this->table);
		$this->db->where_in('ss_aw_id', $question_ids);
		return $this->db->get()->result();
	}

	public function get_question_by_topics($topic){
