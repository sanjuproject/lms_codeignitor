...
public function deleterecord_byid($id)
	...
	public function getdiffuserlogintypenum($program_date){
		$this->db->select('(SELECT count(*) FROM ss_aw_childs WHERE ss_aw_child_enroll_type = 1 and DATE(ss_aw_child_created_date) = "'.$program_date.'" and DATE(ss_aw_child_created_date) >= "2022-08-01") as online,(SELECT count(*) FROM ss_aw_childs WHERE ss_aw_child_enroll_type = 2 and DATE(ss_aw_child_created_date) = "'.$program_date.'" and DATE(ss_aw_child_created_date) >= "2022-08-01") as email_solitation,(SELECT count(*) FROM ss_aw_childs WHERE ss_aw_child_enroll_type = 3 and DATE(ss_aw_child_created_date) = "'.$program_date.'" and DATE(ss_aw_child_created_date) >= "2022-08-01") as offer');
		$this->db->limit(1);
		return $this->db->get($this->table)->result();
	}

	public function getdiffuserlogintypenum_ytd($year){
		$this->db->select('(SELECT count(*) FROM ss_aw_childs WHERE ss_aw_child_enroll_type = 1 and ss_aw_child_status = 1 and ss_aw_child_delete = 0 and YEAR(ss_aw_child_created_date) = "'.$year.'" and DATE(ss_aw_child_created_date) >= "2022-08-01") as online,(SELECT count(*) FROM ss_aw_childs WHERE ss_aw_child_enroll_type = 2 and ss_aw_child_status = 1 and ss_aw_child_delete = 0 and YEAR(ss_aw_child_created_date) = "'.$year.'" and DATE(ss_aw_child_created_date) >= "2022-08-01") as email_solitation,(SELECT count(*) FROM ss_aw_childs WHERE ss_aw_child_enroll_type = 3 and ss_aw_child_status = 1 and ss_aw_child_delete = 0 and YEAR(ss_aw_child_created_date) = "'.$year.'" and DATE(ss_aw_child_created_date) >= "2022-08-01") as offer');
		$this->db->limit(1);
		return $this->db->get($this->table)->result();
	}

	public function getdiffuserlogintypenum_monthly($year, $month){
		$this->db->select('(SELECT count(*) FROM ss_aw_childs WHERE ss_aw_child_enroll_type = 1 and ss_aw_child_status = 1 and ss_aw_child_delete = 0 and YEAR(ss_aw_child_created_date) = "'.$year.'" and MONTH(ss_aw_child_created_date) = "'.$month.'" and DATE(ss_aw_child_created_date) >= "2022-08-01") as online,(SELECT count(*) FROM ss_aw_childs WHERE ss_aw_child_enroll_type = 2 and ss_aw_child_status = 1 and ss_aw_child_delete = 0 and YEAR(ss_aw_child_created_date) = "'.$year.'" and MONTH(ss_aw_child_created_date) = "'.$month.'" and DATE(ss_aw_child_created_date) >= "2022-08-01") as email_solitation,(SELECT count(*) FROM ss_aw_childs WHERE ss_aw_child_enroll_type = 3 and ss_aw_child_status = 1 and ss_aw_child_delete = 0 and YEAR(ss_aw_child_created_date) = "'.$year.'" and MONTH(ss_aw_child_created_date) = "'.$month.'" and DATE(ss_aw_child_created_date) >= "2022-08-01") as offer');
		$this->db->limit(1);
		return $this->db->get($this->table)->result();
	}
	...
	public function get_registration_before_last_seven_days_of_current_date($search_date){
		$this->db->where('ss_aw_child_delete', 0);
		$this->db->where('DATE(ss_aw_child_created_date) <', $search_date);
		$this->db->where('DATE(ss_aw_child_created_date) >=', '2022-08-01');
		return $this->db->get($this->table)->num_rows();
	}
	...
	public function get_daily_diagnostic_non_course_purchase_details($search_date){
		...
		$this->db->from($this->table);
		$this->db->join('ss_aw_parents','ss_aw_parents.ss_aw_parent_id = ss_aw_childs.ss_aw_parent_id');
		$this->db->where('(select count(*) from ss_aw_diagonastic_exam where ss_aw_diagonastic_exam.ss_aw_diagonastic_child_id = ss_aw_childs.ss_aw_child_id and DATE(ss_aw_diagonastic_exam.ss_aw_diagonastic_exam_date) <= "'.$search_date.'") and DATE(ss_aw_diagonastic_exam.ss_aw_diagonastic_exam_date) >= "2022-08-01") > 0');
