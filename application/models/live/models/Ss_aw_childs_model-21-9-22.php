...
public function deleterecord_byid($id)
	...
	public function getdiffuserlogintypenum($program_date){
		$this->db->select('(SELECT count(*) FROM ss_aw_childs WHERE ss_aw_child_enroll_type = 1 and DATE(ss_aw_child_created_date) = "'.$program_date.'") as online,(SELECT count(*) FROM ss_aw_childs WHERE ss_aw_child_enroll_type = 2 and DATE(ss_aw_child_created_date) = "'.$program_date.'") as email_solitation,(SELECT count(*) FROM ss_aw_childs WHERE ss_aw_child_enroll_type = 3 and DATE(ss_aw_child_created_date) = "'.$program_date.'") as offer');
		$this->db->limit(1);
		return $this->db->get($this->table)->result();
	}

	public function getdiffuserlogintypenum_ytd($year){
		$this->db->select('(SELECT count(*) FROM ss_aw_childs WHERE ss_aw_child_enroll_type = 1 and ss_aw_child_status = 1 and ss_aw_child_delete = 0 and YEAR(ss_aw_child_created_date) = "'.$year.'") as online,(SELECT count(*) FROM ss_aw_childs WHERE ss_aw_child_enroll_type = 2 and ss_aw_child_status = 1 and ss_aw_child_delete = 0 and YEAR(ss_aw_child_created_date) = "'.$year.'") as email_solitation,(SELECT count(*) FROM ss_aw_childs WHERE ss_aw_child_enroll_type = 3 and ss_aw_child_status = 1 and ss_aw_child_delete = 0 and YEAR(ss_aw_child_created_date) = "'.$year.'") as offer');
		$this->db->limit(1);
		return $this->db->get($this->table)->result();
	}

	public function getdiffuserlogintypenum_monthly($year, $month){
		$this->db->select('(SELECT count(*) FROM ss_aw_childs WHERE ss_aw_child_enroll_type = 1 and ss_aw_child_status = 1 and ss_aw_child_delete = 0 and YEAR(ss_aw_child_created_date) = "'.$year.'" and MONTH(ss_aw_child_created_date) = "'.$month.'") as online,(SELECT count(*) FROM ss_aw_childs WHERE ss_aw_child_enroll_type = 2 and ss_aw_child_status = 1 and ss_aw_child_delete = 0 and YEAR(ss_aw_child_created_date) = "'.$year.'" and MONTH(ss_aw_child_created_date) = "'.$month.'") as email_solitation,(SELECT count(*) FROM ss_aw_childs WHERE ss_aw_child_enroll_type = 3 and ss_aw_child_status = 1 and ss_aw_child_delete = 0 and YEAR(ss_aw_child_created_date) = "'.$year.'" and MONTH(ss_aw_child_created_date) = "'.$month.'") as offer');
		$this->db->limit(1);
		return $this->db->get($this->table)->result();
	}
