...
class Ss_aw_assisment_diagnostic_model extends CI_Model
{
	...
	public function get_bulk_questions($question_ids = array()){
		$this->db->select('ss_aw_id, ss_aw_question_preface as question_preface, ss_aw_question as question, ss_aw_category as topic_name, ss_aw_level as question_level');
		$this->db->from($this->table);
