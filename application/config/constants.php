...
define('ADVANCED_EMI_DURATION', 6);

//define course readalong counts
define('EMERGING_READALONG', 14);
define('CONSOLATING_READALONG', 25);
define('ADVANCED_READALONG', 26);
...
define('DIAGNOSTIC_QUESTION_NUM', '20');
//define('RAZORPAY_KEY','rzp_live_5E38oBl0w6EgWD');
define('RAZORPAY_KEY','rzp_test_2S11dmRA9QASUR');
// define('FACEBOOK_APP_ID', '772186277348460');
// define('FACEBOOK_APP_SECRET', '0c37647edd065675c88cb0e1e080ebfb');
// define('FACEBOOK_ACCESS_TOKEN', 'EAAKZBTKDDBGwBADZAbErTHNk0obCiRjt09Td2HkzarYp9X6V36d7013ZCsJrQaQ92gAqEzONkixZBjpAUyQm8WXX1ytTJQbaCz8OxNaukBSddUvJ1Jhv64LQ5UAEJaZAxDW64xrVZCLbCbcBBEcHr3zKgCxtVIPJuVXZBlOQdBKklTaNZAtTSPbEkWB7rQJmJN5hJTh07OjHGG4ZBbZAAuweRm');
define('WINNERS_DURATION', 98);
define('CHAMPIONS_DURATION', 175);
define('MASTERS_DURATION', 182);
define('DIAGNOSTIC_DURATION', 180);

define('Winners','Fluency');
define('Master','Master');
define('Champions','Champions');
