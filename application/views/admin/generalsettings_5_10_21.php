                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label for="txtQuizIdleTime">Quiz idle time to skip (sec)</label>
                                                    <input class="form-control" type="text" id="txtQuizIdleTime"
                                                        placeholder="Idle time to skip in sec" name="txtQuizIdleTime" value="<?php echo $result[0]->ss_aw_time_skip; ?>">

                                                    <p class="text-hint"><small>Default: 10 sec</small></p>
                                                </div>
                                                <div class="form-group">
                                                    <label for="txtRecapScreenTime">Time interval for recap screens
                                                        (sec)</label>
                                                    <input class="form-control" type="text" id="txtRecapScreenTime"
                                                        placeholder="Time interval for recap screens in sec" name="txtRecapScreenTime" value="<?php echo $result[0]->ss_aw_time_interval; ?>">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label for="txtPauseWrongTime">Idle time duration for automatic skip
                                                        (sec)</label>
                                                    <input class="form-control" type="text" id="txtPauseWrongTime"
                                                        placeholder="Pause wrong answer time in sec" name="txtPauseWrongTime" value="<?php echo $result[0]->ss_aw_pause_time; ?>">

                                                    <p class="text-hint"><small>Default: 10 sec</small></p>
                                                </div>
												<div class="form-group">
                                                    <label for="txtQuizIdleexitTime">Quiz idle time to exit (sec) </label>
                                                    <input class="form-control" type="text" id="txtQuizIdleexitTime"
                                                        placeholder="Quiz idle time to exit in sec" name="txtQuizIdleexitTime" value="<?php echo $result[0]->ss_aw_time_interval_exit ; ?>">
       ...
       $(document).ready(function() { 
          $("#btnAudio8").click(function(){
            ...
            $.ajax({
              type: 'POST',
              url: url,
              data: {'demoAudioText':demoAudioText,'demo_audio_voice':demo_audio_voice,'language_code':language_code},
              dataType: "text",
              beforeSend: function() {
