        ...
        <div class="content-page">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                            ...
                            <div class="page-title-box">
                                <h5 style="color: red; font-style: italic;">*Use slaes dashboard to send promotional emails.</h5>
                                            ...
                                            if (!empty($result)) {
                                                foreach ($result as $key => $value) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="actioncell">
                                                            <!-- <a href="javascript:void(0);" onclick="getsendpromotionvalue(<?= $value->ss_aw_id; ?>)" class="action-icon"
                                                                data-toggle="modal" data-target="#warning-send-modal"> <i
                                                                    class="mdi mdi-email-send" title="Send Promotion"></i></a> -->
            ...
            <!-- Send promotion warning modal -->
            <!-- Delete confirmation dialog -->
            <div id="warning-send-modal" class="modal fade show" tabindex="-1" role="dialog" aria-modal="true">
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        <div class="modal-body p-4">
                            <div class="text-center">
                                <i class="dripicons-warning h1 text-warning"></i>
                                <h4 class="mt-2">Warning!</h4>
                                <p class="mt-3">Do you really want to send this promotion ?</p>
                                <div class="button-list">
                                    <form id="record_remove_form" method="post" action="<?= base_url(); ?>admin/send_promotion">
                                        <input type="hidden" name="send_promotion_id" id="send_promotion_id">
                                        <button type="submit" class="btn btn-danger">Yes</button>
                                        <button type="button" class="btn btn-success" data-dismiss="modal">No</button>
                                    </form>
                                </div>
...
<script type="text/javascript">
    ...
    function getsendpromotionvalue(promotion_id){
        $("#send_promotion_id").val(promotion_id);
    }
</script>
</body>
