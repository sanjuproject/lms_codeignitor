                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-2">
                                <div class="col-sm-8">
                                    <a href="<?= base_url(); ?>admin/manageinstitutionusers/<?= $institution_id ?>" class="btn btn-light mb-2"><?=Winners?></a>

                                    <a href="<?= base_url(); ?>admin/manageinstitutionmastersusers/<?= $institution_id ?>" class="btn btn-primary mb-2"><?=Master?>s</a>
                                </div>
                                <div class="col-sm-4">
                                    <div class="text-sm-right">
                                        <form action="<?php echo base_url() ?>admin/manageinstitutionmastersusers/<?= $this->uri->segment(3); ?>" method="post" id="filter-form">
                                ...
                                <div class="col-sm-4">
                                    <div class="text-sm-right">
                                        <form action="<?php echo base_url() ?>admin/manageinstitutionmastersusers" method="post" id="filter-form">
                                            <div class="form-group mb-3">
                                                <div class="input-group">
                                                    <input type="text" name="search_data" class="form-control" placeholder="Search..." aria-label="Recipient's username" 
                                                    <?php  
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    if (!empty($course_details[$value->ss_aw_child_id]->course)){
                                                        ?>
                                                        <a href="<?= base_url(); ?>admin/institution_user_course_details/<?= $value->ss_aw_parent_id ?>/<?= $value->ss_aw_child_id; ?>/<?= $page; ?>/2/<?= $institution_details->ss_aw_id; ?>"><?= $value->ss_aw_child_first_name." ".$value->ss_aw_child_last_name; ?></a>
                                                        <?php
                                                    }
                                                    else{
