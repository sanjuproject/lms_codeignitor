										...
										<?php	foreach($result as $key=>$value){
											...
											$topic_desc = $value->ss_aw_topic_description;
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $value->ss_aw_section_title." (". $value->ss_aw_section_reference_no .")";?></td>
                                ...
                                <div class="modal-body p-4">
                                    <div class="text-center">
                                        ...
                                        <div class="button-list">
                                            <form action="<?php echo base_url(); ?>admin/topics/<?= $this->uri->segment(3); ?>" method="post">
                    ...
                    <div class="modal fade" id="modal5-add-topic" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body p-2">
                                    <form action="<?php echo base_url(); ?>admin/topics/<?= $this->uri->segment(3); ?>" class="parsley-examples" id="modal-demo-form" method="post">
                                        <div class="form-group">
                                            <label for="newtopic">Topic Name<span
                                                    class="text-danger">*</span></label>
