                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="terget-audience-radio">
                                                        ...
                                                        <!-- <?php
                                                        if ($upload_details->ss_aw_program_type == 1) {
                                                        ?>
                                                            <div class="radio radio-primary mr-2">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-control custom-switch custom-switch-with">
                                                        <input <?= $upload_details->ss_aw_emi_count > 0 ? "disabled" : ""; ?> name="chk_discount_coupon" type="checkbox" class="custom-control-input" id="chk_discount_coupon" value="0" onclick="applyCoupon();">
            ...
            <div class="modal-body p-4">
                <div class="text-center">
                    ...
                    <div class="button-list">
                        ...
                        <button type="button" class="btn btn-danger" id="payment_confirmation" onclick="payNow();">Yes</button>
...
<script>
    ...
    function getPriceDetails(paymentType) {
        ...
        //Setup EMI section
        console.log("object====================",paymentType);
        // if (paymentType == 2) {
    ...
    function payNow() {
        ...
        let payment_amount = $("#finalamount").val();
        let discount_amount = $("#discountammount").val();
        //var discount_amount = 0; //Discount 0 from admin end
        let coupon_code = $("#discountcoupon").val();
