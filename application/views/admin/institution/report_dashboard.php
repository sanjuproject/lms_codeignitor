        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-4 col-xl-4">
                    <a href="<?php echo base_url(); ?>admin/institution_individual_performance/<?= $this->uri->segment(3); ?>" class="pointer">
                            ...
                            <div class="row">
                                ...
                                <div class="col-9">
                                    <div class="text-center">
                                        <h3 class="mt-1">Individual Performance</h3>
                    ...
                    <a href="<?php echo base_url(); ?>admin/institution_combined_performance/<?= $this->uri->segment(3); ?>" class="pointer">
                        <div class="widget-rounded-circle card-box">
                            <div class="row">
                                ...
                                <div class="col-9">
                                    <div class="text-center">
                                        <h3 class="mt-1">Combined Performance</h3>
                                        <p class="mb-1 counter_size text-warning"></p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-4 col-xl-4">
                    <a href="<?php echo base_url(); ?>admin/institution_module_wise_complete_performance/<?= $this->uri->segment(3); ?>" class="pointer">
                        <div class="widget-rounded-circle card-box">
                            <div class="row">
                                <div class="col-3">
                                    <div
                                ...
                                <div class="col-9">
                                    <div class="text-center">
                                        <h3 class="mt-1">Module-wise Completion Status</h3>
                                        <p class="mb-1 counter_size text-warning"></p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-4 col-xl-4">
                    <a href="<?php echo base_url(); ?>admin/institution_module_wise_incomplete_performance/<?= $this->uri->segment(3); ?>" class="pointer">
                        <div class="widget-rounded-circle card-box">
                            <div class="row">
                                <div class="col-3">
                                    <div
                                ...
                                <div class="col-9">
                                    <div class="text-center">
                                        <h3 class="mt-1">Users yet to Complete Modules</h3>
                                        <p class="mb-1 counter_size text-warning"></p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-4 col-xl-4">
                    <a href="<?php echo base_url(); ?>admin/readalog_count/<?= $this->uri->segment(3); ?>" class="pointer">
                        <div class="widget-rounded-circle card-box">
                            <div class="row">
                                <div class="col-3">
                                    <div
                                ...
                                <div class="col-9">
                                    <div class="text-center">
                                        <h3 class="mt-1">Readalong Count</h3>
                                        <p class="mb-1 counter_size text-warning"></p>
                                    </div>
                                </div>
                            </div>
