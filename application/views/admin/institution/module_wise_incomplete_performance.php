                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($topics)) {
                                                foreach ($topics as $key => $value) {
                                                    $dat = getlastlessondata($institution_details->ss_aw_id, $value['ss_aw_lession_id'], $searchdata['incomplete_user_programme_type']);
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            ?>
                                                                <a href="<?= $dat == 0 ? 'javascript:void(0)' : base_url('admin/lesson_incomplete_users/' . $institution_details->ss_aw_id . '/' . base64_encode($carry != 0 ? $carry_child . ',' . $lessonchild : $lessonchild)) ?>"><?= $carry + $lessonnotcomp; ?></a>
                                                            <?php
                                                            }
                                                            ?>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            ?>
                                                                <a href="<?= $dat == 0 ? 'javascript:void(0)' : base_url('admin/assessment_incomplete_users/' . $institution_details->ss_aw_id . '/' . base64_encode($carry != 0 ? $carry_child . ',' . $assesonchild : $assesonchild)) ?>"><?= $carry + $assesonnotcomp; ?></a>
                                                            <?php
                                                            }
                                                            ?>
