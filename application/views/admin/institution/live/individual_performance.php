        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-6 d-flex justify-content-end">
                    <form method="post" id="demo-form" action="<?= base_url('admin/institution_individual_performance/'.$this->uri->segment(3)); ?>">
                                ...
                                <div class="col-12">
                                    <div class="form-group d-flex justify-content-end align-items-center pt-3">
                                        ...
                                        <select name="programme_type" id="programme_type" class="form-control mt-0">
                                            ...
                                            <option value="5" <?php if(!empty($searchdata['programme_type'])){ if($searchdata['programme_type'] == 5){ ?> selected <?php } } ?>><?=Master?>s</option>
                                        </select>
                    ...
                    ?>
                        <div class="btn-container pt-3 pl-2">
                            <a href="<?= base_url(); ?>export/generateXls_institutionreportdashboard/<?= $institution_details->ss_aw_id; ?>/<?= @$searchdata['programme_type'] ?>" class="btn btn-success align-middle"><i class="mdi mdi-file-excel"></i>Export</a>
                        </div>
                    <?php } ?>
                </div>
            </div>
                                                            ...
                                                            <ul class="row-metrics no-left-margin">
                                                                <li>
                                                                    ...
                                                                    if ($diagnosticcorrectnum[$value->ss_aw_child_id] != 'NA') {
                                                                        ?>
                                                                        <a href="<?= base_url(); ?>admin/institution_diagnostic_question_details/<?= $institution_details->ss_aw_id ?>/<?= $child_id ?>/<?= base64_encode(1) ?>"><?= $diagnosticcorrectnum[$value->ss_aw_child_id]; ?></a>
                                                                        <?php
                                                                    }
                                                                    else{
                                                                        echo "&nbsp;";
                                                                    ...
                                                                    <ul class="row-metrics no-left-margin">
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            if ($lessonscoredata[$value->ss_aw_child_id][$topic['ss_aw_lession_id']] != 'NA') {
                                                                                ?>
                                                                                <a href="<?= base_url(); ?>admin/institution_lesson_quiz_details/<?= $institution_details->ss_aw_id ?>/<?= $child_id; ?>/<?= $topic['ss_aw_lession_id']; ?>/<?= base64_encode(1); ?>"><?= $lessonscoredata[$value->ss_aw_child_id][$topic['ss_aw_lession_id']] ?></a>
                                                                                <?php
                                                                            }
                                                                            else{
                                                                                echo "&nbsp;";
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            if ($assessmentscoredata[$value->ss_aw_child_id][$topic['ss_aw_lession_id']] != 'NA') {
                                                                                ?>
                                                                                <a href="<?= base_url(); ?>admin/institution_assessment_quiz_details/<?= $institution_details->ss_aw_id ?>/<?= $child_id; ?>/<?= $assessment_id_ary[$child_id][$topic['ss_aw_lession_id']]; ?>/<?= base64_encode(1); ?>">
                                                                                    <?= $assessmentscoredata[$value->ss_aw_child_id][$topic['ss_aw_lession_id']] ?>
                                                                                </a>
                                                                                <?php
                                                                            }
                                                                            else{
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            if ($readalongscore[$value->ss_aw_child_id][$topic['ss_aw_lession_id']] != 'NA') {
                                                                                ?>
                                                                                <a href="<?= base_url(); ?>admin/institution_readalong_quiz_details/<?= $institution_details->ss_aw_id ?>/<?= $child_id; ?>/<?= $readalong_id_ary[$child_id][$topic['ss_aw_lession_id']]; ?>/<?= base64_encode(1); ?>"><?= $readalongscore[$value->ss_aw_child_id][$topic['ss_aw_lession_id']] ?></a>
                                                                                <?php
                                                                            }
                                                                            else{
                                                                              echo "&nbsp;";  
