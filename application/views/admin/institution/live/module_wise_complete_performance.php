                                ...
                                <div class="col-12">
                                    <div class="form-group d-flex justify-content-end align-items-center pt-3">
                                        ...
                                        <select name="programme_type" id="programme_type" class="form-control mt-0">
                                            ...
                                            <option value="5" <?php if(!empty($searchdata['complete_user_programme_type'])){ if($searchdata['complete_user_programme_type'] == 5){ ?> selected <?php } } ?>><?=Master?>s</option>
                                        </select>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                if ($readalongnonaccessable[$lesson_id] == 0) {
                                                                    ...
                                                                    ?>
                                                                    <a href="<?= $readalongcompletenum[$lesson_id] == 0 ? 'javascript:void(0)' : base_url('admin/readalong_complete_users/'.$institution_details->ss_aw_id.'/'.base64_encode(implode(",", $readalongcompletechilds[$lesson_id]))) ?>"><?= $readalongcompletenum[$lesson_id]; ?></a>    
                                                                    <?php
                                                                }
                                                                ?>
