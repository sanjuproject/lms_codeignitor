                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    ?>
                                                        <a href="<?= $diagnostic_complete_log->ss_aw_completed_on_time == 0 ? 'javascript:void(0)' : base_url('admin/diagnostic_complete_users/' . $institution_details->ss_aw_id . '/' . base64_encode($diagnostic_complete_log->ss_aw_completed_on_time_users)) ?>/<?= base64_encode(1) ?>"><?= $diagnostic_complete_log->ss_aw_completed_on_time; ?></a>
                                                    <?php
                                                    } else {
                                                        echo '';
                                                    }
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            ?>
                                                                <a href="<?= $value['lessoncompletenum'] == 0 ? 'javascript:void(0)' : base_url('admin/lesson_complete_users/' . $institution_details->ss_aw_id . '/' . base64_encode($value['lessoncompletechilds'])) ?>"><?= $value['lessoncompletenum']; ?></a>
                                                            <?php
                                                            }
                                                            ?>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            ?>
                                                                <a href="<?= $value['assessmentcompletenum'] == 0 ? 'javascript:void(0)' : base_url('admin/assessment_complete_users/' . $institution_details->ss_aw_id . '/' . base64_encode($value['assessmentcompletechilds'])) ?>"><?= $value['assessmentcompletenum']; ?></a>
                                                            <?php
                                                            }
                                                            ?>
