        ...
        <div class="container-fluid">
                ...
                <div class="col-md-12">
                    <div class="page-title-left">
                        <ol class="breadcrumb mb-2">
                            ...
                            <li class="breadcrumb-item">Combined Performance</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="post" id="demo-form" action="<?= base_url('admin/institution_combined_performance/' . $this->uri->segment(3)); ?>">
