            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="btn-container pt-3 pl-2 text-right">
                        <a href="<?= base_url(); ?>admin/view_institution/<?= $institution_details->ss_aw_id; ?>" class="btn btn-danger align-middle"><i class="mdi mdi-arrow-left-bold-circle"></i> Go Back</a>    
                    </div>
                </div>
            </div>
            <!-- end page title -->
...
<script type="text/javascript">
    ...
    function makePayment(uploadId){
        ...
        $.ajax({
            type:"POST",
            url:"<?= base_url(); ?>admin/check_pan_gst",
            data:{"excel_upload_id": uploadId, "institutionId": institution_id},
            dataType:"JSON",
            success:function(data){
                console.log(data);
                if (data.status == 200) {
                    var link = "<?= base_url(); ?>admin/institution_make_payment/"+institution_id+"/"+uploadId;
