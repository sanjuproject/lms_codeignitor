                	...
                	<div class="row">
                        <div class="col-md-10">
                            <div class="page-title-left">
                                <ol class="breadcrumb mb-2">
                                    ...
                                    if ($program_type == 1) {
                                    	?>
                                    	<li class="breadcrumb-item"><a href="<?= base_url(); ?>admin/manageinstitutionusers/<?= $institution_details->ss_aw_id; ?>/<?= $this->uri->segment(5); ?>">Manage Users</a></li>
                                    	<?php
                                    }
                                    else{
                                    	?>
                                    	<li class="breadcrumb-item"><a href="<?= base_url(); ?>admin/manageinstitutionmastersusers/<?= $institution_details->ss_aw_id; ?>/<?= $this->uri->segment(5); ?>">Manage Users</a></li>
                                    	<?php
                                    }
                                    ?>
                                    <li class="breadcrumb-item"><?= $child_details->ss_aw_child_first_name." ".$child_details->ss_aw_child_last_name; ?></li>
                        ...
                        <div class="col-md-2 text-right">
	                        <div class="page-title-left" style="padding: 20px 0px;">
	                            <a href="<?= $program_type == 1 ? base_url().'admin/manageinstitutionusers/'.$institution_details->ss_aw_id : base_url().'admin/manageinstitutionmastersusers/'.$institution_details->ss_aw_id; ?>/<?= $this->uri->segment(5); ?>" class="btn btn-danger align-middle"><i class="mdi mdi-arrow-left-bold-circle"></i> Go Back</a>
	                        </div>
	                    </div>
                    </div>
                    <!-- start page title -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                               ...
                               <div class="col-4">
                                <h4 class="details-title">User Name: <span><?= $child_details->ss_aw_child_first_name." ".$child_details->ss_aw_child_last_name; ?>(<?= $child_details->ss_aw_child_username ? $child_details->ss_aw_child_username : $child_details->ss_aw_child_code; ?>)</span></h4>
                            ...
                            ?></span></h4>
                               ...
                               <h4 class="details-title">Diagnostic Score: <a <?php if ($diagnostic_question_asked > 0) {
                               	?>
                               	href="<?= base_url(); ?>admin/institution_diagnostic_question_details/<?= $institution_details->ss_aw_id ?>/<?= $child_id ?>/<?= base64_encode(2) ?>/<?= base64_encode($program_type); ?>/<?= base64_encode($this->uri->segment(5)); ?>"
                               	<?php
                               }else{
                               	?>
															...
															foreach ($completed_topic_details as $key => $value) {
																...
																<tr class="gradeX " id="<?= $count ?>">
																	...
																	<td class="center bg-lesson"><a <?php if ($lesson_score['asked'][$value->ss_aw_lesson_id] > 0) {
																		?>
																		href="<?= base_url(); ?>admin/institution_lesson_quiz_details/<?= $institution_details->ss_aw_id ?>/<?= $child_id; ?>/<?= $value->ss_aw_lesson_id; ?>/<?= base64_encode(2) ?>/<?= base64_encode($program_type); ?>/<?= base64_encode($this->uri->segment(5)); ?>"
																		<?php
																	}else{
																		?>
																		href="javascript:void(0)"
																	...
																	<td class="center bg-assessment"><a <?php if ($assessment_score['asked'][$value->ss_aw_lesson_id] > 0) {
																		?>
																		href="<?= base_url(); ?>admin/institution_assessment_quiz_details/<?= $institution_details->ss_aw_id ?>/<?= $child_id; ?>/<?= $assessment_id_ary[$value->ss_aw_lesson_id]; ?>/<?= base64_encode(2) ?>/<?= base64_encode($program_type); ?>/<?= base64_encode($this->uri->segment(5)); ?>"
																		<?php
																	}else{
																		?>
																		href="javascript:void(0)"
																	...
																	if ($assessment_score['asked'][$value->ss_aw_lesson_id] != 0) {
																		...
																		?>
																		<a href="<?= base_url(); ?>admin/assessment_subtopic_score/<?= $institution_details->ss_aw_id ?>/<?= $child_id; ?>/<?= $assessment_id_ary[$value->ss_aw_lesson_id]; ?>/<?= base64_encode(2) ?>/<?= base64_encode($program_type); ?>/<?= base64_encode($this->uri->segment(5)); ?>"><i class="fa fa-file"></i></a>
																		<?php
																	}
																	else{
																		echo "Not Completed";
														...
														if (!empty($readalong_lists)) {
															...
															foreach ($readalong_lists as $key => $value) {
																...
																<tr class="gradeX <?= $count % 2 == 0 ? 'blocked-row-bg' : '';?>" id="<?= $count; ?>">
																	...
																	<td class="center bg-assessment"><a <?php if ($value['question_asked'] > 0) {
																		?>
																		href="<?= base_url(); ?>admin/institution_readalong_quiz_details/<?= $institution_details->ss_aw_id; ?>/<?= $child_id; ?>/<?= $value['ss_aw_readalong_id']; ?>/<?= base64_encode(2) ?>/<?= base64_encode($program_type); ?>/<?= base64_encode($this->uri->segment(5)); ?>"
																		<?php
																	}else{
																		?>
																		href="javascript:void(0)"
