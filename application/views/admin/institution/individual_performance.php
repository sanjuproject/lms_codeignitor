...
<style>
    ...
    div.student-name-wrapper {
        display: flex;
        align-items: center;
    }

    div.student-name-wrapper .slno {
        display: block;
        padding: 0 5px;
    }
                                ...
                                <div class="col-12">
                                    <div class="form-group d-flex justify-content-end align-items-center pt-3">
                                        ...
                                        <select name="programme_type" id="programme_type" class="form-control mt-0">
                                            ...
                                            ?>
                                                    <option value="<?= $cour->ss_aw_course_id ?>" <?php if (!empty($searchdata['programme_type'])) {
                                                                                                        if ($searchdata['programme_type'] == $cour->ss_aw_course_id) { ?> selected <?php }
                                                            ...
                                                            <td>
                                                                <ul class="row-metrics no-left-margin">
                                                                    ...
                                                                    <li style="min-height: 25px;">
                                                                        <?php
                                                                        if ($performence[$child_id][$topic['ss_aw_lession_id']]['lessonscore'] != '') {
                                                                        ?>
                                                                            <a href="<?= base_url(); ?>admin/institution_lesson_quiz_details/<?= $institution_details->ss_aw_id ?>/<?= $child_id; ?>/<?= $topic['ss_aw_lession_id']; ?>/<?= base64_encode(1); ?>"><?= $performence[$child_id][$topic['ss_aw_lession_id']]['lessonscore'] ?>%</a>
                                                                        <?php
                                                                        } else {
                                                                            echo "";
                                                                        }
                                                                    ...
                                                                    <li style="min-height: 25px;">
                                                                        <?php
                                                                        if ($performence[$child_id][$topic['ss_aw_lession_id']]['assesmentscore'] != '') {
                                                                        ?>

                                                                            <a href="<?= base_url(); ?>admin/institution_assessment_quiz_details/<?= $institution_details->ss_aw_id ?>/<?= $child_id; ?>/<?= $performence[$child_id][$topic['ss_aw_lession_id']]['ss_aw_assessment_id']; ?>/<?= base64_encode(1); ?>">

                                                                                <?= $performence[$child_id][$topic['ss_aw_lession_id']]['assesmentscore'] ?>%
                                                                            </a>
                                                                        <?php
                                                                        } else {
                                                                            echo "";
