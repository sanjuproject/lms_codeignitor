                                ...
                                <div class="form-group col-md-6">
                                            ...
                                            <div class="terget-audience-radio">
                                               <div class="radio radio-primary mr-2">
                                                ...
                                                <div class="radio radio-primary">
                                                    <input type="radio" name="member" id="All" value="3" required data-parsley-multiple="member">
                                                    <label for="All">
                                                       All
                                                    </label>
                                                </div>
                                        ...
                                        <div class="form-row">
                                           ...
                                           <div class="form-row">
                                              ...
                                              <label>Discount<span class="text-danger">*</span></label>
                                                        <input name="discount" class="form-control" type="text" id="discount" placeholder="Discount" required>
 ...
 <script src="<?= base_url(); ?>assets/js/pages/create-project.init.js"></script>
  ...
  <script src="<?= base_url(); ?>assets/libs/parsleyjs/parsley.min.js"></script>
   ...
   <script>
        ...
        /*jQuery('#coupon_code').on('keypress', function(){
