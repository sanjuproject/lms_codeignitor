                ...
                <div class="content">
                   ...
                   <div class="row">
                        <div class="col-md-12">
                            <div class="page-title-left">
                                <ol class="breadcrumb mb-2">
                                    <li class="breadcrumb-item active"><a href="<?= base_url(); ?>admin/managecoupons">Coupon Management</a></li>
                    ...
                    <div class="row">
                        ...
                        <form action="<?= base_url(); ?>admin/settings" method="post" style="width: 100%;">
                        <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                    ...
                                                    <input name="frequency_new_user" class="form-control" type="text" id="users" placeholder="days" value="<?= $result[0]->ss_aw_frequency_for_new_users; ?>">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="duration">Promotion sending frequecy duration (days)</label>
                                                <input name="frequency_duration" class="form-control" type="text" id="duration" placeholder="days" value="<?= $result[0]->ss_aw_frequency_duration; ?>">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="period">Promotion Rest period (days)</label>
                                                <input name="rest_period" class="form-control" type="text" id="period" placeholder="days" value="<?= $result[0]->ss_aw_rest_period; ?>">
                                            </div>
