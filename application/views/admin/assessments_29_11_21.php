                                        ...
                                        <div class="col-sm-8">
                                                ...
                                                <form action="<?php echo base_url();?>admin_course_content/assessments" method="post" id="demo-form">
                                                    ...
                                                    <div class="row content-right">
                                                          ...
                                                          <input type="text" class="form-control" placeholder="Topic / Section name" aria-label="Topic / Section name" name="topic_name" value="<?php if(!empty($search_parent_data['ss_aw_assesment_topic'])) echo $search_parent_data['ss_aw_assesment_topic'];?>">
