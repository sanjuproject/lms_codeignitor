                ...
                <div class="content">
                   ...
                   <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <h4 class="page-title">Edit Newsletters</h4>
                        </div>


                        <div class="col-lg-12 col-xl-12">
                            <div class="card-box">
                            <form method="post" action="<?= base_url(); ?>admin/edit_newsletter" id="demo-form" data-parsley-validate="">
                            ...
                            <div class="form-group newsletter-required">
                                <div class="custom-control custom-switch custom-switch-newsletter">
                                    <input name="status" value="1" type="checkbox" class="custom-control-input" id="customSwitch2" <?= $result[0]->ss_aw_status == 1 ? "checked" : ""; ?>>
                            ...
                            <div class="form-group">
                                <label for="title">Name<span
                                                        ...
                                                        <input name="title" class="form-control" type="text" id="title" placeholder="Name" required value="<?= $result[0]->ss_aw_title; ?>">
                                           ...
                                           <textarea rows="8" name="template" id="template" class="form-control" placeholder="Write something..." required><?= $result[0]->ss_aw_template; ?></textarea>
                                              </div>
