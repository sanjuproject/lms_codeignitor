 <!-- ============================================================== -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Improvement Report</h4>
                                </div>
                            </div>
                        </div>     
		...
		?>
				<option value="<?= $cour->ss_aw_course_code ?>"<?php if(!empty($improvement_score_searchdata['assign_level'])){ if($improvement_score_searchdata['assign_level'] == $cour->ss_aw_course_code){ ?> selected <?php } } ?>><?= $cour->ss_aw_course_nickname ?></option>
	...
	<?php }
                                        ...
                                        <div class="table-responsive gridview-wrapper">
                                            <?php
                                            if (!empty($decending_improvement_score) && !empty($improvement_score)) {
                                                ?>
                        ...
                        if (!empty($decending_improvement_score) && !empty($improvement_score)) {
                            ...
                            <div class="row">
                                <div>
                                    <a target="_blank" class="btn btn-primary" href="<?= base_url(); ?>report/export_improvement_report/<?= $improvement_score_searchdata['assign_level']; ?>">Download Report as PDF Format</a>
                                </div>
                            </div>
                            <?php
                        }
