                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    if (count(explode(" ", $month)) == 1) {
                                        ?>
                                        <h4 class="page-title">MONTHLY REVENUE RECOGNITION REPORT: <?= date('F', mktime(0, 0, 0, $month, 10)); ?>, <?= $year; ?></h4>
                                        <?php    
                                    }
                                    else{
                                        ?>
                                        <h4 class="page-title">MONTHLY REVENUE RECOGNITION REPORT: <?= $month; ?>- <?= $year; ?></h4>
                                        <?php
                                    }
                                    ?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form method="post" id="demo-form" action="<?= base_url(); ?>report/reporting_revenue">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        if (!empty($revenue_details)) {
                                                            ...
                                                            <div class="row">
                                                                <div>
                                                                    <a target="_blank" class="btn btn-primary" href="<?= base_url(); ?>report/reporting_revenue_export">Download Report</a>
                                                                </div>
                                                            </div>
                                                            <?php
                                                        }
