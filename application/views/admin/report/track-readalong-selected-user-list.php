...
<div class="content-page">
    <div class="content">
                        <?php
                            $page_title = "";
                            if ($type == 1) {
                                $page_title = "PTD readalong selected users of ".$readalong_title;
                            }
                            elseif ($type == 2) {
                                $page_title = "YTD readalong selected users of ".$readalong_title;
                            }
                            else{
                                $page_title = "MTD readalong selected users of ".$readalong_title;
                            }
                        ?>
        <!-- Start Content-->
                            ...
                            <div class="row mb-2">
                                <div class="col-sm-4">
                                    <div class="text-sm-right">
                                        <form action="<?php echo base_url() ?>report/track_readalong_selected_users/<?= $this->uri->segment(3); ?>" method="post" id="filter-form">
