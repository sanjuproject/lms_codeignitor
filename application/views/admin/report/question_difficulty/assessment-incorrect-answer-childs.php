...
<div class="content-page">
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <!-- end page title --> 
            <a href="<?= base_url(); ?>report/assessment_question_difficulty/<?= $page_num; ?>" class="btn btn-primary">Go Back</a>
            <br>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                                    ...
                                    <table class="table table-centered table-striped dt-responsive nowrap w-100"
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($wrong_answer_child_list as $key => $value) {
                                                ...
                                                <tr>
                                                    <td><?= $i ?></td>
                                                    <td><a href="<?= base_url(); ?>admin/assessment_quiz_details/<?= $value->parent_id ?>/<?= $value->child_id; ?>/<?= $assessment_upload_id; ?>" target="_blank"><?= $value->child_name; ?></a></td>
