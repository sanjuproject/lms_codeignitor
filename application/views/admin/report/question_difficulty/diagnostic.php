                         ...
                         <div class="card-body">
                             <div class="row mb-2">
                                 <div class="col-sm-12">
                                     ...
                                     <a href="<?= base_url(); ?>report/diagnostic_question_difficulty" class="btn btn-primary mb-2">Diagnostic</a>
                                         ...
                                         <div class="col-md-3">
                                             <div class="form-group">
                                                 ...
                                                 <select name="student_level" id="student_level" class="form-control" onchange="gettopics();" required>
                                                     <option value="">Choose Level</option><?php
                                             ...
                                             <div class="form-group">
                                                 ...
                                                 <select name="topics" id="topics" class="form-control" required>
                                                     ...
                                                     <?php
                                                        ...
                                                        ?>
                                                             <option value="<?= $value['ss_aw_assesment_topic']; ?>" <?php if (!empty($searchdata['topics'])) {
                                                                                                                            if ($searchdata['topics'] == $value['ss_aw_assesment_topic']) { ?> selected <?php }
                                         ...
                                         <?php
                                            ...
                                            ?>
                                                 ...
                                                 <tr>
                                                     ...
                                                     <td>
                                                         <?php
                                                            if ($value->correct_answre == 0) {
                                                                echo 0;
                                                            } else {
                                                            ?>
                                                             <a href="<?= base_url(); ?>report/diagnostic_wright_answer_childs_list/<?= base64_encode($searchdata['student_level'] . "@" . $value->ss_aw_id . "@" . $value->ss_aw_format . "@" . $this->uri->segment(3)); ?>" target="_blank"><?php echo $value->correct_answre ? $value->correct_answre : 0; ?></a>
                                                         <?php
                                                            }
                                                            ?>
                                                     </td>
                                                     <td>
                                                         <?php
                                                            if ($value->wrong_answre == 0) {
                                                                echo 0;
                                                            } else {
                                                            ?>
                                                             <a href="<?= base_url(); ?>report/diagnostic_wrong_answer_childs_list/<?= base64_encode($searchdata['student_level'] . "@" . $value->ss_aw_id . "@" . $value->ss_aw_format . "@" . $this->uri->segment(3)); ?>" target="_blank"><?php echo $value->wrong_answre ? $value->wrong_answre : 0; ?></a>
                                                         <?php
                                                            }
                                                            ?>
                                                     </td>
