                                        ...
                                        <div class="col-sm-8">
                                                ...
                                                <form action="<?php echo base_url();?>admin_course_content/assessments" method="post" id="demo-form">
                                                    ...
                                                    <div class="row content-right">
                                                          ...
                                                          <input type="text" class="form-control" placeholder="Topic / Section name"
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    ?></a></td>
                                                     ...
                                                     <td><?= date('M d, Y', strtotime($value->ss_aw_create_date)); ?></td>
                                                    <td>
                                                         <?php
                                                        ...
                                                        if ($value->ss_aw_is_demo == 1) {
                                                            ?>
                                                            <a href="javascript:void(0)" onclick="set_demo(<?= $assessment_id; ?>, <?= $value->ss_aw_is_demo; ?>)" class="badge badge-soft-warning" data-toggle="modal" data-target="#warning-demo-modal">Demo for <?=Winners?></a>
                                                            <?php    
                                                        }
                                                        elseif ($value->ss_aw_is_demo == 2) {
                                                            ?>
                                                            <a href="javascript:void(0)" onclick="set_demo(<?= $assessment_id; ?>, <?= $value->ss_aw_is_demo; ?>)" class="badge badge-soft-warning" data-toggle="modal" data-target="#warning-demo-modal">Demo for <?=Master?>s</a>
                                                            <?php
                                                        }
                                                        elseif ($value->ss_aw_is_demo == 3) {
                                                            ?>
                                                            <a href="javascript:void(0)" onclick="set_demo(<?= $assessment_id; ?>, <?= $value->ss_aw_is_demo; ?>)" class="badge badge-soft-warning" data-toggle="modal" data-target="#warning-demo-modal">Demo for Both</a>
                                                            <?php
                                                        }
                                                        else{
                                                            ?>
                                                            <a href="javascript:void(0)" onclick="set_demo(<?= $assessment_id; ?>, <?= $value->ss_aw_is_demo; ?>)" class="badge badge-soft-danger" data-toggle="modal" data-target="#warning-demo-modal">Mark for Demo</a>
                                                            <?php
                                                        }
                                                        ?>
                                                        ...
                                                        elseif ($value->ss_aw_is_demo == 2) {
                                                            ?>
                                                            <a href="javascript:void(0)" onclick="set_demo(<?= $assessment_id; ?>, <?= $value->ss_aw_is_demo; ?>)" class="badge badge-soft-warning" data-toggle="modal" data-target="#warning-demo-modal">Demo for Masters</a>
                                                            <?php
                                                        }
                                                        elseif ($value->ss_aw_is_demo == 3) {
                                                            ?>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="button-list">
                                            <form action="<?php echo base_url() ?>admin_course_content/assessments" method="post">
                                                ...
                                                <input type="hidden" name="pageno" value="<?= $this->uri->segment(3) ? $this->uri->segment(3) : 0; ?>">
                                    ...
                                    <form action="<?php echo base_url();?>admin_course_content/upload_assessment" method="post" enctype="multipart/form-data" id="demo-form" class="parsley-examples" id="modal-demo-form">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select id="format" name="format" class="form-control parsley-error" onchange="setformat(this.value);" required="">
                                                    <option value="">Select</option>
                                        ...
                                        <div class="form-row">
                                             ...
                                             <div class="form-group col-md-12" id="setlevel" style="display:none;">
                                        ...
                                        <div class="form-group col-md-12" id="lesson_name_container">
                                            <label>Assessment Name<span class="text-danger">*</span></label>
										...
										<div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <select id="lesson_list" class="form-control parsley-error" name="selected_lesson" required="">
                        ...
                        <div class="modal-body p-4">
                            <div class="text-center">
                                ...
                                <div style="display: flex; justify-content: space-around; padding-bottom: 10px;">    
                                    ...
                                    <div class="button-list">
                                        <input type="hidden" id="demo_assessment_id" name="demo_assessment_id">   
                                        <input type="hidden" id="demo_assessment_availability" name="demo_assessment_availability">   
...
$("#lesson_list").change(function(){
    $("#lesson_name").val($("#lesson_list").find(":selected").text());
});	
...
function fetchLessonBYLevel(){
    var format = $("#format").val();
    var level = $("#choose_level").val();
    //if (level != "") {
        $.ajax({
            type: "GET",
            url: "<?php echo base_url(); ?>admin_course_content/getlessonbylevel",
            data:{"level":level,"format":format},
...
function change_status(assessment_id,assesment_status){
          ...
          document.getElementById('status_pageno').value = pageno;
     }
...
function set_demo(assessment_id,demo_status){
    console.log({assessment_id});
    var pageno = "<?= $this->uri->segment(3) ? $this->uri->segment(3) : ''; ?>"
    $("#demo_assessment_id").val(assessment_id);
    $("#demo_assessment_availability").val(1);
