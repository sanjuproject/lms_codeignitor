...
<!-- ============================================================== -->
<script src="<?= base_url(); ?>/assets/quiz_challange/fabric.min.js">
</script>
<style>
    #photo {
        padding: 4px;
                            ...
                            <div class="hints_form_container">
                                <div class="hints_indidual_container">
                                    ...
                                    <div class="direction-input mb-3">
                                        ...
                                        <!-- <a class="form-control" href="<?= base_url(); ?>admin/quiz_list_id_wise_view/<?= $value->ss_aw_challange_id; ?>"> <i class="mdi mdi-content-copy"></i></a> -->
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        canvas.setWidth(760);
        canvas.setBackgroundImage('<?= base_url(); ?>/assets/quiz_challange/quiz_background-1.jpeg', canvas.renderAll.bind(canvas), {
        ...
        var text4 = new fabric.Textbox('Accross', {
            left: 410,
            top: 360,
            width: 300,
            fontFamily: 'arial',
        ...
        canvas.add(text1, text2, text3, text4, text5, text_quiz_name);
    });
