                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                               ...
                               <div class="col-4">
                                <h4 class="details-title">Name: <span><?= $child_details->ss_aw_child_nick_name; ?>(<?= $parent_details[0]->ss_aw_parent_email; ?>)</span></h4>
                            ...
                            ?></span></h4>
                               ...
                               <h4 class="details-title">Creation Date: <span><?= date('d/m/Y', strtotime($child_details->ss_aw_child_created_date)); ?></span></h4>
                               </div>
</div>
