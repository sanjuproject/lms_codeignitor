                                                ...
                                                <tr>
                                                    ...
                                                    <td class="actioncell">
                                                        <a href="javascript:void(0);" class="action-icon"
                                                            data-toggle="modal" data-target="#edit-custom-modal" onclick = "return update_data(<?php echo  $faq_id ?>);"
                                                            > <i
...
<script type="text/javascript">
    ...
    function update_data(faq_id)
    {
        $.ajax({
            type: "GET",
            url: "<?= base_url(); ?>admin/getfaqdetail",
            data:{"faq_id":faq_id},
            dataType:"JSON",
            success:function(data){
                document.getElementById('edit_faq_id').value = data.faq_id;
                document.getElementById('edit_question').value = data.faq_question;
                document.getElementById('edit_answer').value = data.faq_answer;
                document.getElementById('edit_faq_user').value = data.faq_user;
