                ...
                <div class="container-fluid">
                        ...
                        <div class="col-md-12">
                            <div class="page-title-left">
                                ...
                                <li class="breadcrumb-item"><a href="<?= base_url(); ?>admin/managecoupons"> Coupon Management </a></li>
                                    <li class="breadcrumb-item active">List of Manage Newsletters</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="page-title-box">
                                <h4 class="page-title">Manage Newsletters</h4>
                            </div>
                        </div>
                        <div class="col-6">
                        <div class="footerformView float-right mt-3 mr-2">
                                ...
                                <form>
                                    <div class="row content-right">
                                        ...
                                        <!-- <option value="2">Add Newsletters</option> -->
                                ...
                                <div class="card-body">
                                    <div class="row mb-2 managecouponlistofcouponsearch">
                                        <div class="col-sm-3">
                                            ...
                                            <a href="<?= base_url(); ?>admin/add_newsletter" class="btn btn-danger mb-2"><i
                                                    class="mdi mdi-plus-circle mr-2"></i>Add Newsletters</a>
                                        </div>
                                        <div class="col-sm-9">
                                            <div class="text-sm-right">
                                                <form method="post" action="<?= base_url(); ?>admin/managenewsletters" id="demo-form">
                                            ...
                                            if (!empty($result)) {
                                                foreach ($result as $key => $value) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="actioncell">
                                                            <a href="<?= base_url(); ?>admin/edit_newsletter/<?= $value->ss_aw_id; ?>" class="action-icon"> <i
                        ...
                        <div class="modal-body p-4">
                            <div class="text-center">
                                ...
                                <div class="button-list">
                                    <form id="record_remove_form" method="post" action="<?= base_url(); ?>admin/remove_newsletter">
