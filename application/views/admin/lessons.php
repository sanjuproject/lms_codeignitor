                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-2">
                                <div class="col-sm-4">
                                    ...
                                    <a href="javascript:void(0);" id="btnImportLesson" class="btn btn-danger mb-2" data-toggle="modal" data-target="#custom-modal"><i class="mdi mdi-plus-circle mr-2"></i>Import new Lesson</a>
                                </div>
                                <!-- start-debasis -->
                                <div class="col-sm-8">
                                        ...
                                        <form action="<?php echo base_url(); ?>admin_course_content/lessons" method="post" id="demo-form">
                                            ...
                                            <div class="row content-right">
                                                <div class="form-group mb-3">
                                                    <div>
                                                        <input type="text" name="topic_name" class="form-control" id="txtFilter" placeholder="Topic / Section name" aria-label="Recipient's username" value="<?php if (!empty($search_parent_data['ss_aw_lesson_topic'])) echo $search_parent_data['ss_aw_lesson_topic']; ?>" />
                                                ...
                                                <div class="form-group mb-3 ml-2 mr-2">
                                                    <div class="input-group">
                                                        <select class="form-control adminusersbottomdropdown" id="drpLevel" name="choose_level" onchange="filter_data();">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <select class="form-control adminusersbottomdropdown" id="drpStatus" name="status" onchange="filter_data();">
                                                ...
                                                <div class="ml-2 mr-2">
                                                    <button type="button" id="btnClearFilter" class="btn btn-danger waves-effect waves-light">Clear</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                ...
                                <table class="table table-centered mb-0" id="inline-editable">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th>Level<br />( E = 1,C = 2, A = 3, M = 4)</th>
                                            <th>Created Date</th>
                                            <th>Modified Date</th>
                                            <th>Status</th>
                                            <th>Action</th>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="custom-control custom-checkbox" id="checkboxdata">
                                                            <input type="checkbox" name="selecteddata[]" value="<?php echo $lesson_id; ?>" class="custom-control-input check_row" id="customCheck<?php echo $key + 2; ?>">
                                                            <label class="custom-control-label" for="customCheck<?php echo $key + 2; ?>"></label>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td><a href="<?= base_url(); ?>admin_course_content/lesson_details/<?= $lesson_id; ?>"><?php echo $value->ss_aw_lesson_topic; ?></a></td>
                                                    <td>
                                                        <?php
                                                        $course_string = "";
                                                        foreach ($courseary as $i => $val) {
                                                            if ($i > 0) {
                                                                $course_string .= ",";
                                                            }
                                                            if ($val == 1)
                                                    ...
                                                    <td>
                                                        <?php
                                                        if ($value->ss_aw_modified_date == '0000-00-00 00:00:00') {
                                                            echo "Not Modified Yet.";
                                                        } else {
                                                            echo date('M d, Y', strtotime($value->ss_aw_modified_date));
                                                        }
                                                        ?>
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        ?>
                                                            ...
                                                            <a href="#" onclick="return change_status('<?php echo $lesson_id ?>',0);" class="badge badge-soft-success" data-toggle="modal" data-target="#warning-status-modal">Active</a>
                                                        <?php
                                                        } else {
                                                        ?>
                                                            <a href="#" onclick="return change_status('<?php echo $lesson_id ?>',1);" class="badge badge-soft-danger" data-toggle="modal" data-target="#warning-status-modal">In Active</a>
                                                        <?php
                                                        }
                                                    }else{?>
                                                   ...
                                                   <?php }
                                                        ...
                                                        ?>
                                                            <a href="javascript:void(0)" onclick="set_demo(<?= $lesson_id; ?>, <?= $value->ss_aw_is_demo; ?>)" class="badge badge-soft-warning" data-toggle="modal" data-target="#warning-demo-modal">Demo for <?= Winners ?></a>
                                                        <?php
                                                        } elseif ($value->ss_aw_is_demo == 2) {
                                                        ?>
                                                            <a href="javascript:void(0)" onclick="set_demo(<?= $lesson_id; ?>, <?= $value->ss_aw_is_demo; ?>)" class="badge badge-soft-warning" data-toggle="modal" data-target="#warning-demo-modal">Demo for <?= Master ?>s</a>
                                                        <?php
                                                        } elseif ($value->ss_aw_is_demo == 3) {
                                                        ?>
                                                            <a href="javascript:void(0)" onclick="set_demo(<?= $lesson_id; ?>, <?= $value->ss_aw_is_demo; ?>)" class="badge badge-soft-warning" data-toggle="modal" data-target="#warning-demo-modal">Demo for Both</a>
                                                        <?php
                                                        } else {
                                                        ?>
                                                            <a href="javascript:void(0)" onclick="set_demo(<?= $lesson_id; ?>, <?= $value->ss_aw_is_demo; ?>)" class="badge badge-soft-danger" data-toggle="modal" data-target="#warning-demo-modal">Mark for Demo</a>
                                                        <?php
                                                        }
                                                        ?>
                                                    ...
                                                    <td>
														...
														'<?php echo $topic; ?>','<?php echo $format; ?>','<?php echo $course; ?>','<?php echo $topic_id; ?>','<?php echo $audio_type; ?>');" data-toggle="modal" data-target="#custom-modal_edit" class="btnUploadAgain btn btn-primary btn-xs btn-rounded waves-effect waves-light">
                                                            Upload Again
                                                        </button>
                                                        <a href="javascript:void(0);" onclick="return lesson_delete('<?php echo $lesson_id; ?>');" class="action-icon" data-toggle="modal" data-target="#warning-delete-modal" title="Delete" data-plugin="tippy" data-tippy-animation="shift-away" data-tippy-arrow="true"> <i class="mdi mdi-delete"></i></a>
                        ...
                        <div class="modal-body p-4">
                            <form action="<?php echo base_url(); ?>admin_course_content/upload_lesson" method="post" class="parsley-examples" id="modal-demo-form" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="select-code-language">Topic<span class="text-danger">*</span></label>
                                        <select id="topic_id" name="topic" class="form-control parsley-error" required="">
                                            <option value="">Select</option>
                                            <?php
                                            foreach ($topicslist as $key => $val) {
                                            ?>
                                                <option value="<?php echo $val->ss_aw_section_id; ?>"><?php echo $val->ss_aw_section_title; ?></option>
                                            <?php } ?>
                                        </select>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6" id="setlevel" style="display:none;">
                                        <label for="select-code-language">Level<span class="text-danger">*</span></label>
                                ...
                                <div class="form-group col-md-12" id="lesson_name_container" style="display: none;">
                                ...
                                <div>
                                    <button type="submit" class="btn btn-blue waves-effect waves-light custom-color">
                                        Add Lesson
                                    </button>
...
opacity: .7;" / />
            ...
            <div id="warning-all-delete-modal" class="modal fade show" tabindex="-1" role="dialog" aria-modal="true">
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        <div class="modal-body p-4">
                            <div class="text-center">
                                ...
                                <div class="button-list">
                                    <button type="button" id="yes_delete_all" class="btn btn-danger">Yes</button>
                                    <button type="button" class="btn btn-success" data-dismiss="modal">No</button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-body p-4">
                    <div class="text-center">
                        ...
                        <form action="<?php echo base_url(); ?>admin_course_content/lessons" method="post">
                            ...
                            <div class="button-list">
                                <input type="hidden" id="demo_lesson_id" name="demo_lesson_id">
                                <input type="hidden" id="demo_lesson_availability" name="demo_lesson_availability">
...
<script>
    ...
    function setformat(value) {
        ...
        if (value != 'Single') {
            ...
            $("#lesson_name_container").css('display', 'block');
            $("#lesson_name").attr('required', true);
        } else {
            $("#topic_id").attr('disabled', false);
            $("#topic_id").attr('required', true);
            $("#setlevel").css('display', 'none');
            $("#lesson_name_container").css('display', 'none');
            $("#lesson_name").attr('required', false);
        }
    }
    ...
    function set_demo(lesson_id, demo_status) {
        console.log({
            lesson_id
        });
        var pageno = "<?= $this->uri->segment(3) ? $this->uri->segment(3) : ''; ?>"
        $("#demo_lesson_id").val(lesson_id);
        $("#demo_lesson_availability").val(1);
    ...
    jQuery('.tableeditCell').on('keypress', function(e) {
        if (e.which == 13) {
            ...
            $.post("<?php echo base_url(); ?>/admin_course_content/updatelesson_seqno", {
                    serial_no: newValue,
                    id: record_id
                })
                .done(function(data) {
