 <!-- ============================================================== -->
                            ...
                            <div class="card-box">
                               ...
                               <form action="#" class="comment-area-box mt-2 mb-3">
                                    ...
                                    $email_template_id = $email_template_resultbyid[0]->ss_aw_email_temp_id;
                                      ...
                                      $email_temp_contain_child = $email_template_resultbyid[0]->ss_aw_child_email_temp_contain;
                                    ?>
                                    <div>
                                        <div>
                                            ...
                                            <div class="row comment-area-btn custom-comment-area-btn ml-0 mr-0">
                                                    ...
                                                    <div class="btn-group float-right">
                                                        ...
                                                        <div class="dynamicTags dropdown-menu" id="drpDynamicTags">
                                                            ...
                                                            if (!empty($notification_param)) {
                                                                ...
                                                                data-value="<?php echo $value->param_value ?>" dynamic_value="<?php echo $email_template_resultbyid[0]->ss_aw_email_temp_id;?>"><?php echo $value->param_name; ?></a>
                                                                    <?php
                                                                }
                                                            }
                                                            ?>
                                            ...
                                            <div>
                                                ...
                                                <div class="row comment-area-btn comment-right-btn m-0">
                                                    <div class="col-3">
                                                        <input class="form-control" type="text" id="test_emails"
                                                            placeholder="Separate multiple emails with comma ',">
                                                    </div>
                                                    <div class="col-2">
                                                        <input class="form-control" type="text" id="email_subject"
                                                            placeholder="Subject">
                                                    </div>
                                                    <div class="col-2">
                                                    ...
                                                    <div class="col-1 float-left pl-0">
                                                        <button type="button" style="font-size:18px;" onclick="return send_test_email('<?php echo $email_template_id ?>', 1)"
                                                    ...
                                                    <div class="col-4">
                                                        <div class="float-right">
                                                            ...
                                                            <button type="button"
                                                                class="btn btn-warning waves-effect waves-light" onclick="return update_email_template('<?php echo $email_template_id ?>','parent')">Update</button>
                                                            <button type="reset"
                                            ...
                                            <div class="row comment-area-btn custom-comment-area-btn ml-0 mr-0">
                                                ...
                                                <div class="col-lg-6 col-xl-6 ">
                                                    <div class="btn-group float-right">
                                                        ...
                                                        <div class="dynamicTags dropdown-menu" id="drpDynamicTags_child">
                                                                <?php
                                                                    if (!empty($notification_param)) {
                                                                        foreach ($notification_param as $key => $value) {
                                                                            ?>
                                            ...
                                            <div>
                                                <textarea rows="8" class="form-control" placeholder="Write something..." id="email_template_contain_child<?php echo $email_template_id; ?>">
                                            <?php echo $email_temp_contain_child;  ?>
                                        
                                            </textarea>
                                                <div class="row comment-area-btn comment-right-btn m-0">
                                                    <div class="col-3">
                                                        <input class="form-control" type="text" id="test_emails_child"
                                                            placeholder="Separate multiple emails with comma ',">
                                                    </div>
                                                    <div class="col-2">
                                                        <input class="form-control" type="text" id="email_subject_child"
                                                            placeholder="Subject">
                                                    </div>
                                                    <div class="col-1 float-left pl-0">
                                                        <button type="button" style="font-size:18px;" onclick="return send_test_email('<?php echo $email_template_id ?>', 2)"
                                                            class="btn btn-success waves-effect waves-light btn-xs" id=""><i
                                                                class="mdi mdi-email-send-outline"></i></button>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="float-right">
                                                            <button type="button"
                                                                class="btn btn-success waves-effect waves-light emailPreview" data-toggle="modal" data-target="#modal1-preview">Preview</button>
                                                            <button type="button"
                                                                class="btn btn-warning waves-effect waves-light" onclick="return update_email_template('<?php echo $email_template_id ?>','child')">Update</button>
                                                            <button type="reset"
                                                                class="btn btn-danger waves-effect waves-light">Cancel</button>
                                                        </div>
                                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="comment-area-btn comment-right-btn">
                                            <div class="float-right">
                                                ...
                                                <!-- end - new added code -->
                                                <button type="button"
                                                        class="btn btn-warning waves-effect waves-light" onclick="return update_app_template('<?php echo $app_temp_id ?>','parent')">Update</button>
                                                <button type="reset"
                                                        class="btn btn-danger waves-effect waves-light">Cancel</button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row comment-area-btn custom-comment-area-btn ml-0 mr-0">
                                        ...
                                        <div class="col-lg-6 col-xl-6 ">
                                            <div class="btn-group float-right">
                                                <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dynamic code list<i class="mdi mdi-chevron-down"></i>
                                                </button>
                                                <div class="dynamicTags dropdown-menu" id="drpDynamicTags_app_child">
                                                    <?php
                                                        if (!empty($notification_param)) {
                                                            foreach ($notification_param as $key => $value) {
                                                            ?>
                                                                <a class="dropdown-item" href="javascript:void(0)" data-value="<?php echo $value->param_value; ?>" dynamic_value="<?php echo $email_template_resultbyid[0]->ss_aw_email_temp_id;?>"><?php echo $value->param_name; ?></a>
                                                            <?php
                                                            }
                                                        }
                                                    ?>
                                    ...
                                    <div>
                                        <textarea rows="8" class="form-control " placeholder="Write something..." id="app_template_contain_child<?php echo $app_temp_id; ?>">
                                                    <?php 
                                                    if(!empty($app_template_resultbyid[0]->ss_aw_app_temp_contain_child)){
                                                    echo $app_template_resultbyid[0]->ss_aw_app_temp_contain_child; 
                                                    }
                                        ...
                                        <div class="comment-area-btn comment-right-btn">
                                            <div class="float-right">
                                                <!-- new added code -->
                                                <button type="button"
                                                        class="btn btn-success waves-effect waves-light inappPreviewChild"
                                                        data-toggle="modal"
                                                        data-target="#modal2-preview">Preview</button>
                                                <!-- end - new added code -->
                                                <button type="button"
                                                        class="btn btn-warning waves-effect waves-light" onclick="return update_app_template('<?php echo $app_temp_id ?>','child')">Update</button>
                                                <button type="reset"
                                                        class="btn btn-danger waves-effect waves-light">Cancel</button>
                                            </div>
                                        </div>
        ...
        <script type="text/javascript">
             function change_app_template_status(id)
         {
          ...
          function update_email_template(id, user_type)
         { 
            var email_template_status; 

            var email_template_contain = $("#email_template_contain"+id).val();
            var email_template_contain_child = $("#email_template_contain_child"+id).val();

            console.log(email_template_contain_child);
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() ?>admin/update_notificationtemplatescms",
                data: {id:id,email_template_contain:email_template_contain,email_template_contain_child:email_template_contain_child,user_type:user_type,'update_template_email':'update_template_email'},
		 ...
		 function send_test_email(id, user_type)
         { 
            var email_template_status; 
            ...
            if (user_type == 1) {
                ...
                var email_template_contain = $("#email_template_contain_child"+id).val();
                var test_emails = $("#test_emails_child").val();
                var email_subject = $("#email_subject_child").val();
            }
            ...
            $.ajax({
                ...
                data: {id:id,email_template_contain:email_template_contain,test_emails:test_emails,email_subject:email_subject,attachment:attachment},
         ...
         function update_app_template(id, user_type)
         { 
            var app_template_status; 

            var app_template_contain = $("#app_template_contain"+id).val();
            var app_template_contain_child = $("#app_template_contain_child"+id).val();
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() ?>admin/update_notificationtemplatescms",
                data: {id:id,app_template_contain:app_template_contain,app_template_status:app_template_status,app_template_contain_child:app_template_contain_child,user_type:user_type,'update_template_app':'update_template_app'},
	...
	<script>
            ...
            jQuery('#drpDynamicTags_child a').on('click', function() {
                
                myValue = jQuery(this).data('value');
                dynamic_value = jQuery(this).attr('dynamic_value');
                
                var cursorPos = jQuery('#email_template_contain_child'+dynamic_value).prop('selectionStart');
                var v = jQuery('#email_template_contain_child'+dynamic_value).val();
                var textBefore = v.substring(0, cursorPos);
                var textAfter = v.substring(cursorPos, v.length);
                jQuery('#email_template_contain_child'+dynamic_value).val(textBefore + myValue + textAfter);
            });
            ...
            jQuery('#drpDynamicTags_app_child a').on('click', function() {
                myValue = jQuery(this).data('value');
                dynamic_value = jQuery(this).attr('dynamic_value');
                
                var cursorPos = jQuery('#app_template_contain_child'+dynamic_value).prop('selectionStart');
                var v = jQuery('#app_template_contain_child'+dynamic_value).val();
                var textBefore = v.substring(0, cursorPos);
                var textAfter = v.substring(cursorPos, v.length);
                jQuery('#app_template_contain_child'+dynamic_value).val(textBefore + myValue + textAfter);
            });
			...
			jQuery(function() {
                ...
                jQuery('.inappPreviewChild').click(function() {
                    let dynamic_value = jQuery('#drpDynamicTags_app_child a').attr('dynamic_value');
                    
                    let targetObj = jQuery('#app_template_contain_child'+dynamic_value);
                    let targetData = targetObj.val();
                    for (let i = 0; i < inAppDataObj.length; i++) {
                        targetData = targetData.replaceAll(inAppDataObj[i][0], inAppDataObj[i][1]);
