        ...
        <script type="text/javascript">
         ...
         { 
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() ?>admin/update_notificationtemplatescms",
                data: {id:id,email_template_contain:email_template_contain,email_template_contain_child:email_template_contain_child,'update_template_email':'update_template_email'},
         ...
         { 
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() ?>admin/update_notificationtemplatescms",
                data: {id:id,app_template_contain:app_template_contain,app_template_status:app_template_status,app_template_contain_child:app_template_contain_child,'update_template_app':'update_template_app'},
