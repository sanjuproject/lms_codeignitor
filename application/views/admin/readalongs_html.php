                                                            ...
                                                            <div class="form-group mb-3">
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control"
                                                                        id="txtFilter" placeholder="Title"
                                                                        aria-label="Title">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" data-toggle="modal"
                                                            data-target="#modal-add-readalong"
                                                        ...
                                                        <a href="images/onlyfordemo.zip" download>
                                                            <div class="avatar-sm">
                                                                <span
                                                                    class="avatar-title bg-light text-secondary rounded">
                                                                    <i class="mdi mdi-folder-zip font-18"
                                                                        title="Filename2" data-plugin="tippy"
                                                                        data-tippy-animation="shift-away"
                                                                        data-tippy-arrow="true"></i>
                                                                </span>
                                                            </div>
                                    ...
                                    <form action="#" id="demo-form" class="parsley-examples" id="modal-demo-form">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label>Linear<span class="text-danger">*</span></label>
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="select-code-language">Level E<span
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                <label>Literature<span class="text-danger">*</span></label>
                                                <select id="" class="form-control parsley-error" required="">
                                                    <option value="">Select</option>
                                                    <option value="1">Option 1</option>
                                                    <option value="2">Option 2</option>
                                            ...
                                            <div class="form-group col-md-12">
                                                <label for="title">ReadAlong Title<span
                                                        class="text-danger">*</span></label>
                                                <input class="form-control parsley-error" type="text" id="title"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <button type="button"
                                                    class="btnUploadAgain btn btn-primary btn-xs btn-rounded waves-effect waves-light">
                                                    Upload Again
                                                    <input type="file" id="fileUploadAgain">
                                                ...
                                                <h6>Note : Only Excel file file format allowed. Sample Directory
                                                    structure and also
                                                    <a href="#">Template</a> file found here.
                                                </h6>
                                            </div>
                                        </div>
