            ...
            <div class="row">
                ...
                <div class="col-6 text-right mt-3">
                    ...
                    if (empty($self_details)) {
                        ?>
                        <a href="<?= base_url(); ?>admin/manageinstitutionusers/<?= $institution_id; ?>/<?= $page; ?>" class="btn btn-danger align-middle"><i class="mdi mdi-arrow-left-bold-circle"></i> Go Back</a>
                        <?php  
                    }
                    else{
                        ?>
                        <a href="<?= base_url(); ?>admin/manageinstitutionmastersusers/<?= $institution_id; ?>/<?= $page; ?>" class="btn btn-danger align-middle"><i class="mdi mdi-arrow-left-bold-circle"></i> Go Back</a>
                        <?php
                    }
                    ?>
                </div>
                        ...
                        <?php
                            if (empty($self_details)) {
                                ...
                                <div class="formWrapper" id="winners-form-fields">
                                    <form class="parsley-examples" method="post" id="demo-form" novalidate="" action="<?= base_url(); ?>admin/edit_institution_user">
                                    ...
                                    <div class="row">    
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="verification-parent">
                                                    <input class="form-control " type="text" name="userid" id="userid" placeholder="Enter user id" required="" parsley-type="userid" value="<?= $child_details[0]->ss_aw_child_username; ?>">
                                        ...
                                        <div class="text-left">
                                            ...
                                            <a class="btn btn-danger waves-effect waves-light m-l-10" href="<?= base_url(); ?>admin/manageinstitutionusers/<?= $institution_id; ?>/<?= $page; ?>">Cancel</a>
                                        </div>
                                        </div>
                                        </form>
                                    </div>
                                ...
                                <div class="formWrapper" id="masters-form-fields">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="text-left">
                                            <input type="submit" class="btn btn-success waves-effect waves-light adminusersbottomgapbetweenbtn adduserbutton" value="Save">
                                            <a class="btn btn-danger waves-effect waves-light m-l-10" href="<?= base_url(); ?>admin/manageinstitutionmastersusers/<?= $institution_id; ?>/<?= $page; ?>">Cancel</a>
                                        </div>
                                    </div>
                                        </form>
                                    </div>
