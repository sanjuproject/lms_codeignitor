                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive gridview-wrapper">
                                ...
                                <div class="row m-0">
                                    ...
                                    <div class="col-sm-4 p-0">
                                        <h4 class="text-muted"><?=Master?>s Programme</h4>
                                ...
                                <a style="font-weight: bold; text-decoration: underline;" href="<?= base_url(); ?>admin/institutionreportdashboard/<?= $institution_details->ss_aw_id ?>">Report Dashboard</a>
                                <a style="font-weight: bold; text-decoration: underline;" href="<?= base_url(); ?>admin/institutionmanagepayment/<?= $institution_details->ss_aw_id ?>">Manage Payment</a>
                            </div>
