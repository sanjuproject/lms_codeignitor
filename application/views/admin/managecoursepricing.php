    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="managecoursepricing card-box">
				...
				<div class="col-md-6">
                    <div class="form-group">
                        <label for="simpleinput">Lump sum price</label>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="simpleinput">Lump sum price(APPLE)</label>
                        <input type="text" placeholder=""  class="form-control autonumber" name="apple_course_price" value="<?php echo $value->ss_aw_apple_course_price; ?>">
                        <input type="hidden" name="update_course_price" value="update_course_price">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="simpleinput">Installment Price</label>
                        <input type="text" placeholder=""  class="form-control autonumber" name="installment_price" value="<?php echo $value->ss_aw_installment_price; ?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="simpleinput">Installment Price(APPLE)</label>
                        <input type="text" placeholder=""  class="form-control autonumber" name="apple_installment_price" value="<?php echo $value->ss_aw_apple_installment_price; ?>">
                    </div>
                </div>	
				</div>	
