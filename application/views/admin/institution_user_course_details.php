                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                               ...
                               <div class="col-4">
                                <h4 class="details-title">Child Name: <span><?= $child_details->ss_aw_child_first_name." ".$child_details->ss_aw_child_last_name; ?>(<?= $child_details->ss_aw_child_username ? $child_details->ss_aw_child_username : $child_details->ss_aw_child_code; ?>)</span></h4>
