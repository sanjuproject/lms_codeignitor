            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="<?php echo base_url() ?>admin/settesttimings" class="parsley-examples" id="modal-demo-form" method="post">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label for="txtQuizIdleTime">Skip Time for Question Format 1 & 2 (sec)</label>
                                                    <input class="form-control" type="text" id="txtQuizIdleTime"
                                                        placeholder="Idle time to skip in sec" name="txtQuizIdleTime" value="<?php echo $generale_time_setting[0]->ss_aw_time_skip; ?>">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label for="txtPauseWrongTime">Skip Time for Question Format 3
                                                        (sec)</label>
                                                    <input class="form-control" type="text" id="txtPauseWrongTime"
                                                        placeholder="Pause wrong answer time in sec" name="txtPauseWrongTime" value="<?php echo $generale_time_setting[0]->ss_aw_pause_time; ?>">
                        ...
                        <input type="hidden" name="record_id" value="<?php echo $generale_time_setting[0]->ss_aw_general_settings_id; ?>">
                    </form>
