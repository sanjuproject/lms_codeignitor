                        ...
                        <div class="col-md-12">
                            <div class="page-title-left">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="<?= base_url(); ?>admin_course_content/lessons">Lessons</a></li>
				...
				<?php include("error_message.php");?>
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <?= form_open(base_url('admin_course_content/lesson_details/'.$this->uri->segment(3))) ?>
                            <input type="hidden" name="lesson_id" value="<?= $this->uri->segment(3); ?>">
                            <select name="course_level" class="form-control" onchange="this.form.submit();">
                                <option value="">Choose Level</option>
                                <?php
                                $course_level_ary = explode(",", $upload_lesson_details[0]->ss_aw_course_id);
                                if (!empty($course_level_ary)) {
                                    foreach ($course_level_ary as $key => $value) {
                                        if (!empty($value)) {
                                            ?>
                                            <option value="<?= $value; ?>" <?php if($value == $course_id){ ?> selected <?php } ?>>
                                                <?php
                                                if ($value == 1) {
                                                    echo "E";
                                                }
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body p-4">
                                    <form method="post" action="<?php echo base_url(); ?>admin_course_content/lesson_details/<?= $this->uri->segment(3); ?>" id="demo-form" class="parsley-examples" id="modal-demo-form-<?= $value['ss_aw_lession_id']; ?>" enctype="multipart/form-data">
                                        <input type="hidden" name="upload_lesson_title" value="1">
                                        <input type="hidden" name="course_level" value="<?= $course_id; ?>">
                    ...
                    <div class="modal fade" id="details-upload-<?= $value['ss_aw_lession_id']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body p-4">
                                    <form method="post" action="<?php echo base_url(); ?>admin_course_content/lesson_details/<?= $this->uri->segment(3); ?>" id="demo-form" class="parsley-examples" id="modal-details-form-<?= $value['ss_aw_lession_id']; ?>" enctype="multipart/form-data">
                                        <input type="hidden" name="upload_lesson_details" value="1">
                                        <input type="hidden" name="course_level" value="<?= $course_id; ?>">
