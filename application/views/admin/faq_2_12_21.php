                                                ...
                                                <tr>
                                                    ...
                                                    <td class="actioncell">
                                                        <a href="javascript:void(0);" class="action-icon"
                                                            data-toggle="modal" data-target="#edit-custom-modal" onclick = "return update_data('<?php echo  $faq_status ?>','<?php echo  $faq_id ?>','<?php echo  $faq_question ?>','<?php echo  $faq_answer ?>');"
                                                            > <i
...
<script type="text/javascript">
    ...
    function update_data(faq_status,faq_id,faq_question,faq_answer)
    {
