                    ...
                    <div class="col-md-12">
                        <div class="page-title-left">
                            <ol class="breadcrumb mb-2">
                                ...
                                <li class="breadcrumb-item active"><a href="<?= base_url(); ?>admin/parentdetail/<?= $parent_id; ?>">Parents</a></li>
                                <li class="breadcrumb-item"><a href="<?= base_url(); ?>admin/child_course_details/<?= $parent_id; ?>/<?= $child_id; ?>">Child Details</a></li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                               ...
                               <div class="col-4">
                                <h4 class="details-title">Child Name: <span><?= $child_details->ss_aw_child_nick_name; ?></span></h4>
                                <h4 class="details-title">Date of app: <span><?php
                            ...
                            ?></span></h4>
                                ...
                                <h4 class="details-title">Promotion Offer Date: <span>NA</span></h4>
                               </div>
                               ...
                               <div class="col-4">
                                    ...
                                    <h4 class="details-title">Promotion accepted Date: <span>NA</span></h4>
                               </div>
                               ...
                               <h4 class="details-title">Date Taken: <span><?= $diagnostic_exam_code_details->ss_aw_diagonastic_exam_date ? date('d/m/Y', strtotime($diagnostic_exam_code_details->ss_aw_diagonastic_exam_date)) : "NA"; ?></span></h4>
                               <h4 class="details-title">Course Recommended: <span>
                               	<?php
                               	if (!empty($recomended_level)) {
                               		if ($recomended_level == "E" || $recomended_level == "C") {
                               			echo Winners;
                               		}
                               		else{
                               			echo Champions;
															...
															foreach ($completed_topic_details as $key => $value) {
																...
																<tr class="gradeX " id="<?= $count ?>">
																	...
																	<td class="center bg-assessment"><a <?php if ($assessment_score['asked'][$value->ss_aw_lesson_id] > 0) {
																		?>
																		href="<?= base_url(); ?>admin/assessment_quiz_details/<?= $parent_id; ?>/<?= $child_id; ?>/<?= $value->ss_aw_lesson_id; ?>"
																		<?php
																	}else{
																		?>
																		href="javascript:void(0)"
														...
														if (!empty($readalong_lists)) {
															...
															foreach ($readalong_lists as $key => $value) {
																...
																<tr class="gradeX " id="<?= $count; ?>">
																	...
																	<td class="center bg-assessment"><a <?php if ($lesson_score['asked'][$value->ss_aw_lesson_id] > 0) {
																		?>
