            ...
            <div class="content">
				...
				<?php include("error_message.php");?>
                                            ...
                                            <tbody>
                                                    ...
                                                    <audio src="<?php echo base_url().$value['ss_aw_readalong_audio']; ?>" id="sound_<?= $value['ss_aw_readalong_id']; ?>"></audio>
                                                                   ...
                                                                   <td style="width: 190px;">
                                                                    ...
                                                                    ?>    
                                                                    <button onclick="return uploadText(<?= $value['ss_aw_readalong_id']; ?>,'<?= $content; ?>')" class="btn btn-warning waves-effect btn-xs waves-light" type="button" data-toggle="modal" data-target="#text-upload">Edit Text</button>
                    ...
                    <div class="modal fade" id="audio-upload" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <!-- Modal -->
                    <div class="modal fade" id="text-upload" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header bg-light">
                                    <h4 class="modal-title" id="myCenterModalLabel">Edit Text</h4>
                                    <button type="button" class="close" data-dismiss="modal"
                                        aria-hidden="true">×</button>
                                </div>
                                <div class="modal-body p-4">
                                    <form method="post" action="<?php echo base_url(); ?>admin_course_content/upload_readalong_content" id="demo-form" class="parsley-examples" id="modal-demo-form" enctype="multipart/form-data">
...
<style type="text/css">
    ...
    <script type="text/javascript">
        ...
        function uploadText(readalongId, content){
            jQuery("#content_id").val(readalongId);
