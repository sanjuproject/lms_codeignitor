...
?>
<input type="hidden" class="upload imgInp" value="<?php echo $ss_aw_admin_user_crop_pic;?>" id="upload_img" name="old_cropped_image" />
<div class="edit-photo text-center">
 <div class="croppedImageContainer">
  <img src="<?php echo $profile_pic;?>" alt="" id="drag-image1"/>
</div>

<div id="cropped_preview" class="rounded-circle img-thumbnail">
<img src="<?php echo $profile_pic;?>" alt='Profile Image' width='100%' height='auto' id="drag-image1" />
</div>
