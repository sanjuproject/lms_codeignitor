                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                if (!empty($course_details[$value->ss_aw_child_id]->course)) {
                                                    if ($course_details[$value->ss_aw_child_id]->course == 1 || $course_details[$value->ss_aw_child_id]->course == 2) {
                                                        echo Winners;
                                                    }
                                                    elseif ($course_details[$value->ss_aw_child_id]->course == 3){
                                                        echo Champions;
                                                    }
                                                    elseif ($course_details[$value->ss_aw_child_id]->course == 5){
                                                        echo Master."s";
                                                    }
                                                }
                                                else{
