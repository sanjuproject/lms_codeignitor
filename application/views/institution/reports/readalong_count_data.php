        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-6 d-flex justify-content-end">
                    <form method="post" id="demo-form" action="<?= base_url('institution/readalong_count/'.$institution_id); ?>">
                                            ...
                                            foreach ($childs as $key => $value) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php if ($value->count_readalong != '') { ?>
                                                            <a href="<?=base_url("institution/getallreadalongdata/$child_id")?>" target="_blank"><?= $value->count_readalong ?></a>
                                                        <?php
                                                        } else {
                                                            echo 0;
                                                        }
