                ...
                <div class="col-6 d-flex justify-content-end">
                    ...
                    ?>
                        <div class="btn-container pt-3 pl-2">
                            <a href="<?= base_url(); ?>export/generateXls_institutionreportdashboard/<?= $institution_details->ss_aw_id; ?>/<?= @$searchdata['programme_type'] ?>/1" class="btn btn-success align-middle"><i class="mdi mdi-file-excel"></i>Export</a>
                        </div>
                    <?php } ?>
                </div>
