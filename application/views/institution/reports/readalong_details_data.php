                ...
                <div class="col-md-12">
                    <div class="page-title-left">
                        <ol class="breadcrumb mb-2">
                            ...
                            <li class="breadcrumb-item"><a href="<?= base_url(); ?>institution/readalong_count">Readalong Count</a></li>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($readalong_details as $key => $value) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a target="_blank" href="<?= base_url(); ?>institution/readalnongscoredetails/<?= $this->uri->segment(3); ?>/<?= $value['ss_aw_id']; ?>"><?= $value['right_answer']."/".$value['total_question'] ?></a></td>                                              
                                                </tr>  
                                                <?php
                                                $sl++;
                                            }
