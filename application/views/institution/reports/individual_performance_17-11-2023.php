...
<div class="content-page">
    <div class="content">
		...
		?>
				<option value="<?= $cour->ss_aw_course_id ?>"<?php if(!empty($searchdata['programme_type'])){ if($searchdata['programme_type'] == $cour->ss_aw_course_id){ ?> selected <?php } } ?>><?= $cour->ss_aw_course_nickname ?></option>
	...
	<?php }
                                ...
                                ?>
                                    <div class="btn-container pt-3 pl-2">
                                        <a href="<?= base_url(); ?>export/generateXls_institutionreportdashboard/<?= $institution_id; ?>/<?= @$searchdata['programme_type'] ?>/1" class="btn btn-success align-middle"><i class="mdi mdi-file-excel"></i>Export</a>
                                    </div>
                                <?php } ?>
                            </div>
