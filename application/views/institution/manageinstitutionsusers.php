                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-2">
                                <div class="col-sm-8">
                                    <a href="<?= base_url(); ?>institution/manage_users" class="btn btn-primary mb-2"><?= Winners ?></a>

                                    <a href="<?= base_url(); ?>institution/manage_master_users" class="btn btn-light mb-2"><?= Master ?>s</a>
                                </div>
                                <div class="col-sm-4">
                                        ...
                                        ?>
                                            <tr>
                                                <td>
                                                    ...
                                                    ?>
                                                        <a href="<?= base_url(); ?>institution/user_course_details/<?= $value->ss_aw_parent_id ?>/<?= $value->ss_aw_child_id; ?>/<?= $page; ?>/1"><?= $value->ss_aw_child_first_name . " " . $value->ss_aw_child_last_name; ?></a>
                                                    <?php
                                                    } else {
