                                                    ...
                                                    <tr>
                                                        <td colspan="5" style="background-color: #23a509;">
                                                            <p style="color: #ffffff;font-family: 'Roboto', sans-serif;font-weight: 400;font-size: 14px;text-align: justify;margin:5px 0px;padding-left: 15px;padding-right: 15px;">
                                                                ...
                                                                <?php } else { ?>
                                                                    Topics where <b><?= ucfirst(strtolower($child_details->ss_aw_child_first_name)) ?></b> is performing above peer median:
                                                                <?php } ?></b>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td colspan="5">
                                                            <p style="color: #797106;font-family: 'Roboto', sans-serif;font-weight: 400;font-size: 16px;text-align: justify;margin:5px 0px;padding: 0px 15px 12px 15px;">
                                                                ...
                                                                <?php } else { ?>
                                                                    <b><?= ucfirst(strtolower($child_details->ss_aw_child_first_name)) ?></b> scored higher than the peer median in these topics suggesting commendable effort.
                                                                <?php } ?>
                                                            </p>
                                                        </td>
                                                    </tr>                                                    
                                                        ...
                                                        <td colspan="5" style="background-color: #fea10e;">
                                                            <p style="color: #ffffff;font-family: 'Roboto', sans-serif;font-weight: 400;font-size: 14px;text-align: justify;margin:5px 0px;padding-left: 15px;padding-right: 15px;">
                                                               <b> <?php if ($child_details->course_level == 'M') { ?>
                                                                ...
                                                                <?php } else { ?>
                                                                    Topics where <b><?= ucfirst(strtolower($child_details->ss_aw_child_first_name)) ?></b> is performing at peer median:
                                                                <?php } ?></b>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td colspan="5">
                                                            <p style="color: #797106;font-family: 'Roboto', sans-serif;font-weight: 400;font-size: 16px;text-align: justify;margin:5px 0px;padding: 0px 15px 12px 15px;">
                                                                ...
                                                                <?php if ($child_details->course_level == 'M') { ?>
                                                                    While you performed at par with the peer median, there is scope for improvement. We recommend that you redo these Lessons so that you attain a better understanding of the topics they cover.
                                                                <?php } else { ?>
                                                                    While <b><?= ucfirst(strtolower($child_details->ss_aw_child_first_name)) ?></b> is performing at par 
                                                                    with the peer median, there is scope for improvement. We recommend that <b><?= ucfirst(strtolower($child_details->ss_aw_child_first_name)) ?></b> should review these Lessons again so that <?= $child_details->ss_aw_child_gender == 1 ? 'he' : 'she' ?> attains a better understanding of the topics. 
                                                                <?php } ?>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td colspan="5" style="background-color: #FF0000;">
                                                            <p style="color: #ffffff;font-family: 'Roboto', sans-serif;font-weight: 400;font-size: 14px;text-align: justify;margin:5px 0px;padding-left: 15px;padding-right: 15px;">
                                                                ...
                                                                <?php } else { ?>
                                                                    Topics where <b><?= ucfirst(strtolower($child_details->ss_aw_child_first_name)) ?></b> is performing below 
                                                                    peer median:
                                                                <?php } ?></b>
                                                            </p>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td colspan="5">
                                                            <p style="color: #797106;font-family: 'Roboto', sans-serif;font-weight: 400;font-size: 16px;text-align: justify;margin:5px 0px;padding: 0px 15px 12px 15px;">
                                                                ...
                                                                <?php } else { ?>
                                                                    <b style="margin-left:5px;"><?= ucfirst(strtolower($child_details->ss_aw_child_first_name)) ?></b> would benefit a great deal 
                                                        ...
                                                        <td colspan="5" style="background-color: #23a509;">
                                                            <p style="color: #ffffff;font-family: 'Roboto', sans-serif;font-weight: 500;font-size: 14px;text-align: justify;margin:5px 0px;padding-left: 15px;padding-right: 15px;">
                                                               ...
                                                               <b> <?php if ($child_details->course_level == 'M') { ?>
                                                                    Topics where you performed above peer median:
                                                                <?php } else { ?>
                                                                    Topics where <b><?= ucfirst(strtolower($child_details->ss_aw_child_first_name)) ?></b> is performing above peer median - No further action required:
                                                                <?php } ?></b>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td colspan="5">
                                                            <p style="color: #797106;font-family: 'Roboto', sans-serif;font-weight: 400;font-size: 16px;text-align: justify;margin:5px 0px;padding: 0px 15px 12px 15px;">
                                                                <img src="<?= base_url() ?>images/info_orange.png" alt="" style="width: 25px; margin-top: 0px;vertical-align: top;">
                                                                <?php if ($child_details->course_level == 'M') { ?>
                                                                    While you performed at par with the peer median, there is scope for improvement. We recommend that you redo Lessons so that you attain a better understanding of the topics they cover.
                                                                <?php } else { ?>
                                                                    While <b><?= ucfirst(strtolower($child_details->ss_aw_child_first_name)) ?></b> is performing at par 
                                                                    with the peer median, there is scope for improvement. We recommend that <b><?= ucfirst(strtolower($child_details->ss_aw_child_first_name)) ?></b> should review these Lessons again so that <?= $child_details->ss_aw_child_gender == 1 ? 'he' : 'she' ?> attains a better understanding of the topics. 
                                                                <?php } ?>
...
<?php } ?>
<p style="color: #797106;font-family: 'Roboto', sans-serif;font-weight: 400;font-size: 18px;text-align: justify; text-align: center;">We hope this report helped you to gain a proper understanding of <?= $child_details->course_level != 'M' ? "<b>" . ucfirst(strtolower($child_details->ss_aw_child_first_name)) . "'s</b>" : "your" ?> results.</p>
