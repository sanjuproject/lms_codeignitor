                                                    ...
                                                    <tr>
                                                        <td colspan="5">
                                                            <p style="color: #797106;font-family: 'Roboto', sans-serif;font-weight: 400;font-size: 16px;text-align: justify;margin:5px 0px;padding: 0px 15px 12px 15px;">
                                                                ...
                                                                <?php if ($child_details->course_level == 'M') { ?>
                                                                    While you performed at par with the peer median, there is scope for improvement. 
                                                                    We recommend you review the lessons again, going over your difficulty areas to attain complete and clear understanding.
                                                                <?php } else { ?>
                                                                    While <b><?= ucfirst(strtolower($child_details->ss_aw_child_first_name)) ?></b> is performing at par 
                                                                    with the peer median, there is scope for improvement. We recommend having 
                                                                    <b><?= ucfirst(strtolower($child_details->ss_aw_child_first_name)) ?></b> review the lessons again and going over 
                                                                    <?= $child_details->ss_aw_child_gender == 1 ? 'his' : 'her' ?> difficulty areas to attain 
                                                    ...
                                                    <tr>
                                                        <td colspan="5">
                                                            <p style="color: #797106;font-family: 'Roboto', sans-serif;font-weight: 400;font-size: 16px;text-align: justify;margin:5px 0px;padding: 0px 15px 12px 15px;">
                                                                ...
                                                                <?php if ($child_details->course_level == 'M') { ?>
                                                                    You would benefit a great deal from reviewing some of his lessons again, 
...
<?php } ?>
<p style="color: #797106;font-family: 'Roboto', sans-serif;font-weight: 400;font-size: 18px;text-align: justify; text-align: center;">We hope this report helped you gain a proper understanding of <?= $child_details->course_level != 'M' ? "<b>" . ucfirst(strtolower($child_details->ss_aw_child_first_name)) . "'s</b>" : "your" ?> results.</p>
