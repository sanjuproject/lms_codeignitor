                                        ...
                                        <table style="width: 100%;" cellspacing="0" cellpadding="0">
                                            ...
                                            <tbody>
                                                ...
                                                if (!empty($course_details_grammer_first)) {
                                                    ...
                                                    <tr>
                                                        <td colspan="5" style="background-color: #23a509;">
                                                            <p style="color: #ffffff;font-family: 'Roboto', sans-serif;font-weight: 400;font-size: 14px;text-align: justify;margin:10px 0px;padding-left: 15px;padding-right: 15px;">
                                                    ...
                                                    <tr>
                                                        <td colspan="5">
                                                            <p style="color: #797106;font-family: 'Roboto', sans-serif;font-weight: 400;font-size: 18px;text-align: justify;margin:10px 0px;padding-left: 15px;padding-right: 15px;">
                                                                <img src="<?= base_url() ?>images/information.png" alt="" style="width: 22px; margin-top: 8px;vertical-align: top;" >
                                                                <?php if ($child_details->course_level == 'M') { ?>
                                                ...
                                                if (!empty($course_details_grammer_second)) {
                                                    ?>
                                                    <tr>
                                                        <td colspan="5" style="background-color: #FFE135;">
                                                            <p style="color: #ffffff;font-family: 'Roboto', sans-serif;font-weight: 400;font-size: 14px;text-align: justify;margin:10px 0px;padding-left: 15px;padding-right: 15px;">
                                                                <?php if ($child_details->course_level == 'M') { ?>
                                                    ...
                                                    <tr>
                                                        <td colspan="5">
                                                            <p style="color: #797106;font-family: 'Roboto', sans-serif;font-weight: 400;font-size: 18px;text-align: justify;margin:10px 0px;padding-left: 15px;padding-right: 15px;">
                                                                <img src="<?= base_url() ?>images/info_orange.png" alt="" style="width: 25px; margin-top: 8px;vertical-align: top;">
                                                                <?php if ($child_details->course_level == 'M') { ?>
                                                ...
                                                if (!empty($course_details_grammer_third)) {
                                                    ...
                                                    <tr>
                                                        <td colspan="5">
                                                            <p style="color: #797106;font-family: 'Roboto', sans-serif;font-weight: 400;font-size: 18px;text-align: justify;margin:10px 0px;padding-left: 15px;padding-right: 15px;">
                                                                <img src="<?= base_url() ?>images/information_red.png" alt="" style="width: 20px; margin-top: 8px;vertical-align: top;" >
                                                                <?php if ($child_details->course_level == 'M') { ?>
                                                                ...
                                                                <?php } else { ?>
                                                                    <b><?= ucfirst(strtolower($child_details->ss_aw_child_first_name)) ?></b> would benefit a great deal 
