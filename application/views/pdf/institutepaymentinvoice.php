                        ...
                        <tr>
                            <td cellpadding="0" cellspacing="0"  style="width:340px;border-bottom:1px solid black; border-right:1px solid black; width:340px">
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        <td class="name-heading" style="padding-left:5px"><?= $institution_details->ss_aw_name; ?></td>
                                    </tr>
                                    <tr>
                                        <td class="small-text" style="padding-left:5px"><?= $institution_details->ss_aw_address; ?></td>
                                    </tr>
                                    <tr>
                                        <td class="small-text" style="padding-left:5px" ><?= $institution_details->ss_aw_city; ?> <?= $institution_details->ss_aw_pincode; ?></td>
                                    </tr>
                                    <?php
                                    if (!empty($institution_details->ss_aw_gst_no)) {
                                        ?>
                                        <tr>
                                            <td class="small-text" style="padding-left:5px">GSTIN/UIN: <?= $institution_details->ss_aw_gst_no; ?></td>
                                        </tr>
                                        <?php
                                    }
                                    ?>
                                    ...
                                    <?php
                                    if (!empty($institution_details->ss_aw_pan_no)) {
                                        ?>
                                        <tr>
                                            <td class="small-text" style="padding-left:5px">PAN: <?= $institution_details->ss_aw_pan_no; ?></td>
                                        </tr>
                                        <?php
                                    }
                                    ?>
                                    <tr>
                                        <td class="small-text" style="padding-left:5px">State Name: <?= $institution_details->state_name; ?></td>
                                    </tr>
                            ...
                            <td style="border-bottom:1px solid black; width: 360px; vertical-align: top;">
                                ...
                                <table  cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        <td style="border-bottom:1px solid black; width:170px;border-right:1px solid black; padding-left:5px; font-size:16px;" class="invoice-no text-bold"><?= $invoice_no; ?></td>
                                        <td style="border-bottom:1px solid black; width:170px; font-size:16px; padding-left:5px" class="invoice-no text-bold"><?= date('d/m/Y'); ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="invoice-no text-bold" style="border-right:1px solid black;border-bottom:1px solid black; padding-left:5px; font-size:16px;">
                                            <?php
                                                $invoiceAry = explode("/", $invoice_no);
                                                echo $invoiceAry[1].'/'.$invoiceAry[2];
                                            ?>
                                        </td>
                                        <td cellpadding="0" cellspacing="0" class="invoice-no text-bold" style="border-bottom:1px solid black; padding-left:5px; font-size:16px;"><?= date('d/m/Y'); ?></td>
                                    </tr>
                                </table>
                            </td>
                ...
                <table cellpadding="0" cellspacing="0" style="clear: both; border-bottom:1px solid black;  width:100%">
                    ...
                    <tr>
                        ...
                        <td style="width:50%; border-right:1px solid black; border-top:1px solid black; height:40px; text-align: left; padding-left:10px; font-weight: bold;">
                            <?php 
                                if ($course_id == 1 || $course_id == 2) {
                                    $purchased_course_name = Winners;
                                }
                                elseif($course_id == 3){
                                    $purchased_course_name = Champions;
                                }
                                elseif($course_id == 6){
                                    $purchased_course_name = Diagnostic;
                                }
                                else{
                                    $purchased_course_name = Master."s";
                                }
                            ?>
                            <p>Alsowise® <?= $purchased_course_name; ?> Programme</p>
                            <?php
                            if ($payment_type == 1) {
                                ?>
                                <p>For the month of <?= date('F') ?>, <?= date('Y') ?></p>    
                                <?php
                            }
                            ?>
                        </td>
                        <td style="width:14%;border-top:1px solid black; height:40px; text-align: right; padding-right:10px; font-weight: bold;">
                            <?php
                            if (!empty($coupon_id)) {
                                echo number_format((($payment_amount + $discount_amount) - $gst_rate), 2);
                            }
                            else{
                                echo number_format(($payment_amount - $gst_rate), 2);
                            }
                            ?>
                        </td>
                    </tr>
        ...
        <tr>
            <td style="border-bottom:1px solid black;">
                ...
                <table cellpadding="0" cellspacing="0" style="clear: both;border-left:1px solid black; border-right:1px solid black; width:100%">
                    ...
                    <tr>
                        <td style="padding-left:10px; font-weight: bold;">INR <?= AmountInWords($payment_amount); ?></td>
                    </tr>
                </table>
            </td>
        </tr>
