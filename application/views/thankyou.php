    ...
    <div style="width: 100%;background-color: #f9ef7e;text-align: left;padding: 20px;box-sizing: border-box;">
        ...
        <div
            ...
            <div style="width:100%; height:100%; margin:0 auto;">
                <div style="width:120px; height:120px;background-color:darkgreen; border-radius:50%; margin:0 auto">
                    <p style="text-align: center; line-height:150px;"><i class="fa fa-check"
                            style="font-size:46px; color:#fff; position: relative; top: -7px;"></i></p>
            ...
            <p
                style="font-family: 'Roboto', sans-serif;color: #576081;font-size: 16px;font-weight: 300; padding: 20px 0px 5px;margin:0;">
                Thank you for your payment. <strong>Your payment has been successfully processed </strong>
            </p>
            <br>
            <br>
            <p
