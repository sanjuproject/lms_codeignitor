                            ...
                            <div class="table-responsive gridview-wrapper">
                                <table class="table table-centered table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    <td><a href="<?= base_url(); ?>diagnostic/view_institution/<?= $value->ss_aw_id; ?>/<?= $page; ?>"><?= $value->ss_aw_name; ?></a></td>
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url(); ?>diagnostic/update_institutions/<?= $value->ss_aw_id; ?>" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
