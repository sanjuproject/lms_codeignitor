            ...
            <div class="content-page">
                <div class="content">
                   ...
                   <div class="row">
                        <div class="col-md-12">
                            <div class="page-title-left">
                                <ol class="breadcrumb mb-2">
                                    <li class="breadcrumb-item active"><a href="<?= base_url(); ?>diagnostic/manage_institutions">Manage Institutions</a></li>
                    ...
                    <form class="parsley-examples" method="post" id="frm-add-institution" novalidate="" action="<?= base_url(); ?>diagnostic/update_institutions" style="box-shadow: 0px 0px 5px #000; padding: 20px 35px; border-radius: 10px;">
                        ...
                        <div class="row" id="step1">
                            ...
                            <div class="col-sm-12">
                                <div class="text-center">
                                    ...
                                    <a href="<?= base_url(); ?>diagnostic/manage_institutions" class="btn btn-danger waves-effect waves-light m-l-10">Cancel</a>
                                </div>
                            </div>        
                        </div>
