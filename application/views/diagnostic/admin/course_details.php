                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-6">
                                    <a href="<?= base_url(); ?>diagnostic/manageinstitutionusers/<?= $this->uri->segment(3); ?>/<?= $this->uri->segment(4); ?>" style="float: right;" class="btn btn-danger align-middle"><i class="mdi mdi-arrow-left-bold-circle"></i> Go Back</a>
                                </div>
                            </div>
