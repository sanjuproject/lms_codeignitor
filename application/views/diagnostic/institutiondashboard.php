        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-6 col-xl-3">
                    <a href="<?php echo base_url(); ?>diagnostic_institution/manage_users" class="pointer">
                ...
                // if (!empty($last_payment)) {
                    $last_payment_date = $last_payment->ss_aw_created_at!=""?date('d/m/Y', strtotime($last_payment->ss_aw_created_at)):"";
                  
                    ?>
                    <div class="col-md-6 col-xl-3">
                        <a href="<?php echo base_url(); ?>diagnostic_institution/manage_payment" class="pointer">
                            <div class="widget-rounded-circle card-box">
                                <div class="row">
                                    <div class="col-3">
                                        <div
                                    ...
                                    <div class="col-9">
                                        <div class="text-center">
                                            ...
                                            <p class="mb-1 counter_size text-primary"><?= $last_payment_date; ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
