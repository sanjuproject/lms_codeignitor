                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        ?>
                                                            <a href="<?= base_url(); ?>diagnostic_institution/user_course_details/<?= $value->ss_aw_parent_id ?>/<?= $value->ss_aw_child_id; ?>/<?= $page; ?>/1"><?= $value->ss_aw_child_first_name . " " . $value->ss_aw_child_last_name; ?></a>
                                                        <?php
                                                        } else {
                                                    ...
                                                    <td class="actioncell">
                                                        <a href="<?= base_url(); ?>diagnostic_institution/edit_user/<?= $value->ss_aw_child_id ?>/<?= $this->uri->segment(3); ?>" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
                                                        <?php
                                                        if (empty($course_details[$value->ss_aw_child_id]->course)) {
                                                        ?>
