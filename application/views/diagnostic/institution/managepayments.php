                                        ...
                                        if (!empty($result)) {
                                            foreach ($result as $key => $value) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?= base_url(); ?>diagnostic_institution/upload_user_list/<?= $value->ss_aw_id; ?>"><?= $value->ss_aw_student_number; ?></a></td>
...
<script type="text/javascript">
    ...
    function makePayment(uploadId){
        $.ajax({
            type:"POST",
            url:"<?= base_url(); ?>diagnostic_institution/check_pan_gst",
            data:{"excel_upload_id": uploadId},
            dataType:"JSON",
            success:function(data){
                console.log(data);
                if (data.status == 200) {
                    var link = "<?= base_url(); ?>diagnostic_institution/make_payment/"+uploadId;
