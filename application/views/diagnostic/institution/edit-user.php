        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-6 text-right mt-3">
                    <a href="<?= base_url(); ?>diagnostic_institution/manage_users" class="btn btn-danger align-middle"><i class="mdi mdi-arrow-left-bold-circle"></i> Go Back</a>
                </div>
            </div>
            <!-- end page title -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="formWrapper" id="masters-form-fields">
                                <form class="parsley-examples" method="post" id="demo-form" novalidate="" action="<?= base_url(); ?>diagnostic_institution/edit_user">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="text-left">
                                            ...
                                            <a class="btn btn-danger waves-effect waves-light m-l-10" href="<?= base_url(); ?>diagnostic_institution/manage_users">Cancel</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
